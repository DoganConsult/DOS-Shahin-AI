...
const dispatch = {
  ...
  ...Object.fromEntries(
    [
      ...
      ['data-governance-os', 4022], ['billing-os', 4048], ['feature-flag-os', 4049],
      ['security-secrets-os', 4050], ['telemetry-os', 4051], ['schema-authoring-os', 4027],
      ['deployment-os', 4028], ['release-os', 4029], ['vendor-risk-os', 4034],
      ['marketplace-os', 4052], ['dr-os', 4053],
    ].map(([code, port]) => [
      `${code}:evaluate`,
      async () => {
