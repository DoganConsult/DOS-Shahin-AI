...
export type ControlLifecycleState = 'design' | 'draft' | 'under_review' | 'approved' | 'effective' | 'deprecated' | 'archived';
export type MappingRelationship = 'equivalent' | 'partial' | 'related' | 'derived_from';
...
export type SourceSystemType = 'siem' | 'iam' | 'itsm' | 'cmdb' | 'vuln' | 'outlook' | 'sharepoint' | 'teams' | 'onedrive' | 'google_drive' | 'jira' | 'servicenow' | 'splunk' | 'elastic' | 'crowdstrike' | 'aws' | 'azure' | 'gcp' | string;
...
export type EvidenceFrequency = 'daily' | 'weekly' | 'monthly' | 'quarterly' | 'semi_annual' | 'annual' | 'on_demand' | 'continuous';
...
export interface AIAgentStatusLog {
    agentCode?: string;
...
export interface AutonomousWorkflowConfig {
    workflowId?: string;
    autonomyLevel?: AutonomyLevel;
