 ...
 */
export type DataAssetType = 'table' | 'view' | 'schema' | 'database' | 'file' | 'api_endpoint' | 'topic' | 'dataset' | 'report' | 'object_store' | 'model';
...
export type DataType = 'string' | 'integer' | 'float' | 'boolean' | 'date' | 'datetime' | 'timestamp' | 'json' | 'array' | 'binary' | 'uuid';
...
export type DQRuleType = 'completeness' | 'uniqueness' | 'validity' | 'accuracy' | 'consistency' | 'timeliness' | 'referential_integrity' | 'custom_sql';
...
export type RetentionBasis = 'legal_requirement' | 'contractual' | 'business_need' | 'regulatory' | 'archival' | 'operational';
