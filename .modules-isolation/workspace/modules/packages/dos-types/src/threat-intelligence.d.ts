...
export type ThreatActorType = 'nation_state' | 'criminal_group' | 'hacktivist' | 'insider' | 'terrorist' | 'unknown';
...
export type MitreTacticId = 'TA0001' | 'TA0002' | 'TA0003' | 'TA0004' | 'TA0005' | 'TA0006' | 'TA0007' | 'TA0008' | 'TA0009' | 'TA0010' | 'TA0011' | 'TA0040' | 'TA0042' | 'TA0043';
...
export type MalwareType = 'trojan' | 'ransomware' | 'worm' | 'rootkit' | 'spyware' | 'adware' | 'backdoor' | 'loader' | 'dropper' | 'infostealer' | 'cryptominer' | 'botnet' | 'apt_tool' | 'unknown';
...
export type IOCType = 'ip' | 'domain' | 'url' | 'file_hash_md5' | 'file_hash_sha1' | 'file_hash_sha256' | 'email' | 'registry_key' | 'mutex' | 'user_agent' | 'asn' | 'ssl_cert_fingerprint' | 'bitcoin_address' | 'cve' | 'yara_rule';
...
export type PlaybookType = 'phishing' | 'ransomware' | 'malware' | 'data_breach' | 'ddos' | 'insider_threat' | 'account_takeover' | 'supply_chain' | 'custom';
...
export type DarkWebAlertType = 'credential_leak' | 'data_for_sale' | 'brand_mention' | 'threat_discussion' | 'ransomware_post' | 'executive_mention' | 'source_code_leak';
