...
export const VENDOR_STATUSES: readonly VendorStatus[] = ['prospect', 'onboarding', 'active', 'under_review', 'suspended', 'offboarded', 'archived'] as const;

export type VendorSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';

export const VENDOR_SOURCES: readonly VendorSource[] = ['manual', 'import', 'api', 'workflow', 'ai_agent', 'system'] as const;
