...
export const ANALYTICS_EVENT_CONTRACT: ModuleEventContract = {
...
export const ANALYTICS_PUBLISHED_EVENTS = Object.keys(ANALYTICS_EVENT_CONTRACT.published);
export const ANALYTICS_CONSUMED_EVENTS = Object.keys(ANALYTICS_EVENT_CONTRACT.consumed);


export const ANALYTICS_EVENT_LEGACY_ALIASES: Record<string, string> = {};

export const ANALYTICS_EVENT_ORDERING = {
  strictOrdering: true,
...
export const ANALYTICS_EVENT_SECURITY = {
...
export const ANALYTICS_EVENT_CORRELATION = {
