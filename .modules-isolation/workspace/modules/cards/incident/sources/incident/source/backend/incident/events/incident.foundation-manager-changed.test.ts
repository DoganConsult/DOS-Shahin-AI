/**
 * Phase 2 — incident subscriber for foundation.org.manager.changed.
 */
...
import { getSubscriptionHandlers } from './incident.subscribers';

const { createProcessTaskMock } = mocks;

describe('Phase 2 incident ← foundation.org.manager.changed', () => {
  beforeEach(() => {
