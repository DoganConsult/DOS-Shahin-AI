...
export async function permanentlyDeleteExpiredDocuments(
  ...
  try {
    ...
    const expiredRes = await safeQuery(
      `SELECT document_id, deleted_at, recovery_period_days, legal_hold
...
export async function listDeletedDocuments(
  ...
  try {
    const res = await safeQuery(
      `SELECT document_id, title, document_type, deleted_at, deleted_by, recovery_period_days,
