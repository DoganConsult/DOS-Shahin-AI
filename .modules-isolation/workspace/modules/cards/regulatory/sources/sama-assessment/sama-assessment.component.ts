...
@Component({
  ...
  template: `
    <app-page-shell
      ...
      [title]="i18n.translate('samaAssessment.title') !== 'samaAssessment.title' ? i18n.translate('samaAssessment.title') : 'SAMA CSF Assessment'"
      [subtitle]="i18n.translate('samaAssessment.subtitle') !== 'samaAssessment.subtitle' ? i18n.translate('samaAssessment.subtitle') : 'Guided self-assessment against SAMA Cyber Security Framework'"
      [breadcrumbs]="['Dashboard', 'SAMA CSF Assessment']"
      [loading]="loading">

      <!-- Assessment List View -->
      <ng-container *ngIf="!activeAssessment && !wizardMode">
        <div class="list-toolbar">
          <p-button [label]="i18n.translate('samaAssessment.newAssessment') !== 'samaAssessment.newAssessment' ? i18n.translate('samaAssessment.newAssessment') : i18n.translate('ncaAssessment.newAssessment')"
        ...
        <div *ngIf="!loading && assessments.length === 0" class="empty-state">
          <i class="pi pi-building-columns" style="font-size: var(--font-size-6xl); color: var(--primary); margin-bottom: 16px;"></i>
          <h3>{{ i18n.translate('samaAssessment.noAssessments') !== 'samaAssessment.noAssessments' ? i18n.translate('samaAssessment.noAssessments') : i18n.translate('ncaAssessment.noAssessments') }}</h3>
          <p>{{ i18n.translate('samaAssessment.startFirstAssessment') !== 'samaAssessment.startFirstAssessment' ? i18n.translate('samaAssessment.startFirstAssessment') : i18n.translate('ncaAssessment.startFirstAssessment') }}</p>
          <p-button [label]="i18n.translate('samaAssessment.startAssessment') !== 'samaAssessment.startAssessment' ? i18n.translate('samaAssessment.startAssessment') : i18n.translate('ncaAssessment.startAssessment')"
        ...
        <div *ngIf="currentStep === 0" class="intro-step">
          <div class="intro-card">
            <div class="intro-icon">
              <i class="pi pi-building-columns" style="font-size: var(--font-size-6xl); color: var(--primary);"></i>
            </div>
            ...
            <div class="intro-stats">
              <div class="intro-stat">
                ...
                <div class="intro-stat-label">{{ i18n.translate('samaAssessment.domains') !== 'samaAssessment.domains' ? i18n.translate('samaAssessment.domains') : i18n.translate('ncaAssessment.domains') }}</div>
              </div>
              <div class="intro-stat">
                <div class="intro-stat-val">{{ structure.stats.totalSubdomains }}</div>
                <div class="intro-stat-label">{{ i18n.translate('samaAssessment.subdomains') !== 'samaAssessment.subdomains' ? i18n.translate('samaAssessment.subdomains') : i18n.translate('ncaAssessment.subdomains') }}</div>
              </div>
              <div class="intro-stat">
                <div class="intro-stat-val">{{ structure.stats.totalControls }}</div>
                <div class="intro-stat-label">{{ i18n.translate('samaAssessment.controls') !== 'samaAssessment.controls' ? i18n.translate('samaAssessment.controls') : i18n.translate('ncaAssessment.controls') }}</div>
              </div>
            </div>

            <p-button [label]="i18n.translate('samaAssessment.beginAssessment') !== 'samaAssessment.beginAssessment' ? i18n.translate('samaAssessment.beginAssessment') : i18n.translate('ncaAssessment.beginAssessment')"
                      icon="pi pi-arrow-right" (onClick)="currentStep = 1" styleClass="p-button-lg mt-4" />
          </div>
        </div>

        <!-- Steps 1-4: Domain Assessment -->
        <ng-container *ngFor="let domain of structure.domains; let dIdx = index">
          <div *ngIf="currentStep === dIdx + 1" class="domain-step">
            ...
            <div class="step-actions">
              <p-button *ngIf="dIdx > 0" [label]="i18n.translate('samaAssessment.previous') !== 'samaAssessment.previous' ? i18n.translate('samaAssessment.previous') : i18n.translate('ncaAssessment.previous')"
                        icon="pi pi-arrow-left" (onClick)="currentStep = dIdx" styleClass="p-button-outlined" />
              <p-button [label]="i18n.translate('samaAssessment.saveProgress') !== 'samaAssessment.saveProgress' ? i18n.translate('samaAssessment.saveProgress') : i18n.translate('ncaAssessment.saveProgress')"
                        icon="pi pi-save" (onClick)="saveProgress()" styleClass="p-button-outlined" />
              <p-button [label]="dIdx < structure.domains.length - 1
                          ? (i18n.translate('samaAssessment.nextDomain') !== 'samaAssessment.nextDomain' ? i18n.translate('samaAssessment.nextDomain') : i18n.translate('ncaAssessment.nextDomain'))
                          : (i18n.translate('samaAssessment.viewResults') !== 'samaAssessment.viewResults' ? i18n.translate('samaAssessment.viewResults') : i18n.translate('ncaAssessment.viewResults'))"
        ...
        <div *ngIf="currentStep === structure.domains.length + 1 && activeAssessment" class="results-step">
          ...
          <div class="charts-row">
            <div class="chart-card">
              <div class="chart-title"><i class="pi pi-chart-pie"></i> {{ i18n.translate('samaAssessment.domainRadar') !== 'samaAssessment.domainRadar' ? i18n.translate('samaAssessment.domainRadar') : i18n.translate('ncaAssessment.domainRadar') }}</div>
              <canvas #radarChart></canvas>
            </div>
            <div class="chart-card">
              <div class="chart-title"><i class="pi pi-chart-bar"></i> {{ i18n.translate('samaAssessment.statusDistribution') !== 'samaAssessment.statusDistribution' ? i18n.translate('samaAssessment.statusDistribution') : i18n.translate('ncaAssessment.statusDistribution') }}</div>
          ...
          <p-table aria-label="Data table" [value]="getGapItems()" [paginator]="true" [rows]="15" [rowsPerPageOptions]="[10,15,25,50]"
            ...
            <ng-template pTemplate="header">
              <tr>
                <th pSortableColumn="code">{{ i18n.translate('samaAssessment.code') !== 'samaAssessment.code' ? i18n.translate('samaAssessment.code') : i18n.translate('ncaAssessment.code') }}</th>
                ...
                <th pSortableColumn="priority">{{ i18n.translate('samaAssessment.priority') !== 'samaAssessment.priority' ? i18n.translate('samaAssessment.priority') : i18n.translate('ncaAssessment.priority') }}</th>
          ...
          <!-- Cross-Navigation to Related Pages -->
          <div class="cross-nav-section">
            ...
            <div class="cross-nav-cards">
              <a routerLink="/nca-assessment" class="cross-nav-card" style="--cn-color: #1e40af">
                <i class="pi pi-shield" style="color: #1e40af; font-size: var(--font-size-2xl);"></i>
                <div class="cn-text">
                  <div class="cn-title">NCA ECC Assessment</div>
                  <div class="cn-desc">Assess compliance against NCA Essential Cybersecurity Controls</div>
                </div>
                <i class="pi pi-arrow-right"></i>
              </a>
              <a routerLink="/regulatory-feeds" class="cross-nav-card" style="--cn-color: #0d9488">
                <i class="pi pi-rss" style="color: #0d9488; font-size: var(--font-size-2xl);"></i>
                <div class="cn-text">
                  <div class="cn-title">Regulatory Feeds</div>
                  <div class="cn-desc">Stay updated with the latest SAMA and regulatory announcements</div>
                </div>
                <i class="pi pi-arrow-right"></i>
              </a>
          ...
          <div class="step-actions">
            <p-button [label]="i18n.translate('samaAssessment.editAssessment') !== 'samaAssessment.editAssessment' ? i18n.translate('samaAssessment.editAssessment') : i18n.translate('ncaAssessment.editAssessment')"
                      icon="pi pi-pencil" (onClick)="currentStep = 1" styleClass="p-button-outlined" />
            <p-button [label]="i18n.translate('samaAssessment.backToList') !== 'samaAssessment.backToList' ? i18n.translate('samaAssessment.backToList') : i18n.translate('ncaAssessment.backToList')"
  ...
  styles: [`
    ...
    .wizard-step-btn.active .step-num { background: rgba(var(--color-white-rgb), 0.2); color: #fff; }
...
export class SAMAAssessmentComponent implements OnInit, OnDestroy {
  ...
  wizardMode = false;
  currentStep = 0;
  structure: SAMAStructure | null = null;
  assessments: GrcRecord[] = [];
  activeAssessment: GrcRecord | null = null;
  ...
  ngOnInit(): void {
    ...
    this.autoSaveSub = this.autoSave$.pipe(debounceTime(3000)).subscribe(() => this.autoSaveProgress());
  }
  ...
  private autoSaveProgress(): void {
    ...
    this.complianceSvc.updateSAMAItems(this.activeAssessmentId, updates).subscribe({
      next: (r) => { this.activeAssessment = r; this.saving = false; this.cdr.markForCheck(); },
      error: () => { this.saving = false; this.cdr.markForCheck(); },
    });
  }

  private loadStructure(): void {
    this.complianceSvc.getSAMAStructure().subscribe({
      next: (s: any) => {
        this.structure = s;
        this.wizardSteps = [
  ...
  private loadAssessments(): void {
    this.complianceSvc.listSAMAAssessments().subscribe({
      next: (r) => {
  ...
  startNewAssessment(): void {
    this.complianceSvc.createSAMAAssessment().subscribe({
      next: (r) => {
        this.activeAssessmentId = (r as any).assessmentId ?? r.id;
        this.loadAssessment((r as any).assessmentId ?? r.id);
      },
  ...
  loadAssessment(id: string): void {
    this.loading = true;
    this.complianceSvc.getSAMAAssessment(id).subscribe({
      next: (a) => {
        ...
        this.currentStep = a.status === 'completed' ? (this.structure?.domains.length || 4) + 1 : 0;
        this.loading = false;
        this.cdr.markForCheck();
  ...
  getSubdomainAssessed(domainId: string, sd: SAMASubdomain): number {
    return sd.controls.filter(c => this.getItemStatus(c.id) !== 'not_implemented').length;
  }

  getSubdomainProgress(domainId: string, sd: SAMASubdomain): number {
  ...
  getGapItems(): GrcRecord[] {
    if (!this.activeAssessment) return [];
    const gaps = this.activeAssessment.items.filter(
      (i: GrcRecord) => i.status === 'not_implemented' || i.status === 'partially'
    );
    const order: Record<string, number> = { critical: 0, high: 1, medium: 2, low: 3 };
    return gaps.sort((a, b) => (order[a.priority] ?? 4) - (order[b.priority] ?? 4));
  }

  downloadExport(format: 'pdf' | 'excel' | 'html', lang?: string): void {
    if (!this.activeAssessmentId) return;
    const url = this.complianceSvc.exportSAMAAssessment(this.activeAssessmentId, format, lang);
    this.apiclientSvc.getBlob(url.replace('/api', '')).subscribe({
      next: (blob) => {
        const a = document.createElement('a');
        a.href = URL.createObjectURL(blob);
        const ext = format === 'pdf' ? 'pdf' : format === 'excel' ? 'xlsx' : 'html';
        a.download = `sama-csf-assessment.${ext}`;
        a.click();
  ...
  private renderCharts(): void {
    ...
    if (this.radarChartRef?.nativeElement) {
      ...
      this.radarChartInstance = new Chart(this.radarChartRef.nativeElement, {
        type: 'radar',
        data: {
          labels: this.activeAssessment.domainScores.map((d) => this.i18n.localize(d.nameEn, d.nameAr)),
          datasets: [{
            label: this.i18n.translate('dashboardCharts.compliance') + ' %',
            data: this.activeAssessment.domainScores.map((d) => d.score),
      ...
      this.donutChartInstance = new Chart(this.donutChartRef.nativeElement, {
        ...
        data: {
          labels: [
            ...
            this.i18n.translate('samaAssessment.partial') !== 'samaAssessment.partial' ? this.i18n.translate('samaAssessment.partial') : this.i18n.translate('ncaAssessment.partial'),
            this.i18n.translate('samaAssessment.notImpl') !== 'samaAssessment.notImpl' ? this.i18n.translate('samaAssessment.notImpl') : this.i18n.translate('ncaAssessment.notImpl'),
            this.i18n.translate('samaAssessment.na') !== 'samaAssessment.na' ? this.i18n.translate('samaAssessment.na') : this.i18n.translate('ncaAssessment.na'),
          ],
          datasets: [{
