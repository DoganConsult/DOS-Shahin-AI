...
import { UCFBrowserComponent } from '../../../../../../../modules/ucf-browser/ucf-browser.component';
...
@Component({
  ...
  selector: 'app-framework-hub', standalone: true,
  imports: [CommonModule, RouterModule, FrameworksComponent, FrameworkMappingComponent, UCFBrowserComponent, AgentBadgeComponent, HubConnectionsStripComponent],
  styles: [HUB_STYLES],
  template: `
    <div class="grc-hub" [dir]="i18n.direction()">
      <header class="hub-header">
        <div class="hub-title-row">
          <div class="hub-icon-wrap" style="background:#dbeafe"><i class="pi pi-th-large hub-icon" style="color:#1d4ed8"></i></div>
          <div>
