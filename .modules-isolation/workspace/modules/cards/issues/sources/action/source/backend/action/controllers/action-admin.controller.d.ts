...
export declare function getOverdueAnalytics(req: AuthenticatedRequest, res: Response): Promise<void>;
export declare function getAssigneeWorkload(req: AuthenticatedRequest, res: Response): Promise<void>;
