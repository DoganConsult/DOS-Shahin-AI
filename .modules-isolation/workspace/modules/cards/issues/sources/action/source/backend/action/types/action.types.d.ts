...
export declare const ACTION_STATUSES: readonly ActionStatus[];
export type ActionPriority = 'critical' | 'high' | 'medium' | 'low';
export declare const ACTION_PRIORITIES: readonly ActionPriority[];
export type ActionSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';
export declare const ACTION_SOURCES: readonly ActionSource[];
