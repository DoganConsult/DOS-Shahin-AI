/**
 * Phase 2 — remediation subscriber for foundation.org.manager.changed.
 */
...
import { getSubscriptionHandlers } from './remediation.subscribers';

const { createProcessTaskMock } = mocks;

describe('Phase 2 remediation ← foundation.org.manager.changed', () => {
  beforeEach(() => {
