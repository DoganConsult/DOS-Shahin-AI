...
import { Component, OnInit, OnDestroy, inject, computed, ChangeDetectionStrategy, ChangeDetectorRef, DestroyRef } from '@angular/core';
...
export class EvidenceTasksComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.subs.push(this.live.debounced(800).pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => this.loadTasks()));
    this.loadTasks();
  }
