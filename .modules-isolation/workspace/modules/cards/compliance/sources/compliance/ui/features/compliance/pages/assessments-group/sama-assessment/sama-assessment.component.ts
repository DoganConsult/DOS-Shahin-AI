...
@Component({
    ...
    imports: [
        ...
        AccordionModule, ButtonModule, TilesModule, TableModule, TagModule,
    ...
    templateUrl: './sama-assessment.component.html',
    styleUrls: ['./sama-assessment.component.scss']
})
export class SAMAAssessmentComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.autoSaveSub = this.autoSave$.pipe(debounceTime(TIMING.AUTOSAVE_DEBOUNCE)).subscribe(() => this.autoSaveProgress());
  }
  ...
  startNewAssessment(): void {
    this.complianceSvc.createSAMAAssessment().subscribe({
      next: (r) => {
        this.activeAssessmentId = (r as any).assessmentId;
        this.loadAssessment((r as any).assessmentId);
      },
