/**
 * Phase 6 — controls subscriber for foundation.dept_created (F-050).
 */
...
describe('Phase 6 controls ← foundation.dept_created', () => {
  ...
  it('creates one control_owner_placeholder task per event', async () => {
