...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AppDatePipe, FormsModule, PageHeaderComponent, ModuleTabsBarComponent, TableModule, TagModule, ButtonModule, ToolbarModule, DropdownModule, InputTextModule, TooltipModule],
  template: `
...
export class AuditTrailComponent implements OnInit {
  ...
  selectEntry(e: Record<string, unknown>): void {
    this.selectedEntry.set(this.selectedEntry() === e ? null : e);
  }

  filterByEntity(e: Record<string, unknown>): void {
    this.entityTypeFilter = e.entity_type;
    this.entityIdFilter = e.entity_id;
    this.resetAndLoad();
  }

  formatState(e: Record<string, unknown>): string {
