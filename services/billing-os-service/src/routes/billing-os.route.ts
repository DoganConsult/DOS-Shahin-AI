...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/billing-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/billing-os.schemas.js';

export const billingOsRouter = Router();

billingOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
billingOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
billingOsRouter.post('/records', async (req: Request, res: Response) => {
...
billingOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
billingOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
billingOsRouter.post('/events', async (req: Request, res: Response) => {
...
billingOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
