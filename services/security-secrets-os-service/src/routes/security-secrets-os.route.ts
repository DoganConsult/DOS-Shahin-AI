...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/security-secrets-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/security-secrets-os.schemas.js';

export const securitySecretsOsRouter = Router();

securitySecretsOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
securitySecretsOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
securitySecretsOsRouter.post('/records', async (req: Request, res: Response) => {
...
securitySecretsOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
securitySecretsOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
securitySecretsOsRouter.post('/events', async (req: Request, res: Response) => {
...
securitySecretsOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
