...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/marketplace-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/marketplace-os.schemas.js';

export const marketplaceOsRouter = Router();

marketplaceOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
marketplaceOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
marketplaceOsRouter.post('/records', async (req: Request, res: Response) => {
...
marketplaceOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
marketplaceOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
marketplaceOsRouter.post('/events', async (req: Request, res: Response) => {
...
marketplaceOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
