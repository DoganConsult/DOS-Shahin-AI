...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/notification-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/notification-os.schemas.js';

export const notificationOsRouter = Router();

notificationOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
notificationOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
notificationOsRouter.post('/records', async (req: Request, res: Response) => {
...
notificationOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
notificationOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
notificationOsRouter.post('/events', async (req: Request, res: Response) => {
...
notificationOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
