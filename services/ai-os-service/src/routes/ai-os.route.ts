...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/ai-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/ai-os.schemas.js';

export const aiOsRouter = Router();

aiOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
aiOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
aiOsRouter.post('/records', async (req: Request, res: Response) => {
...
aiOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
aiOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
aiOsRouter.post('/events', async (req: Request, res: Response) => {
...
aiOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
