...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/telemetry-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/telemetry-os.schemas.js';

export const telemetryOsRouter = Router();

telemetryOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
telemetryOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
telemetryOsRouter.post('/records', async (req: Request, res: Response) => {
...
telemetryOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
telemetryOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
telemetryOsRouter.post('/events', async (req: Request, res: Response) => {
...
telemetryOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
