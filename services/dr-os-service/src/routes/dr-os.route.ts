...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/dr-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/dr-os.schemas.js';

export const drOsRouter = Router();

drOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
drOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
drOsRouter.post('/records', async (req: Request, res: Response) => {
...
drOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
drOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
drOsRouter.post('/events', async (req: Request, res: Response) => {
...
drOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
