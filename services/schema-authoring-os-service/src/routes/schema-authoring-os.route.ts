...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/schema-authoring-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/schema-authoring-os.schemas.js';

export const schemaAuthoringOsRouter = Router();

schemaAuthoringOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
schemaAuthoringOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
schemaAuthoringOsRouter.post('/records', async (req: Request, res: Response) => {
...
schemaAuthoringOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
schemaAuthoringOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
schemaAuthoringOsRouter.post('/events', async (req: Request, res: Response) => {
...
schemaAuthoringOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
