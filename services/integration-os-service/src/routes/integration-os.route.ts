...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/integration-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/integration-os.schemas.js';

export const integrationOsRouter = Router();

integrationOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
integrationOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
integrationOsRouter.post('/records', async (req: Request, res: Response) => {
...
integrationOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
integrationOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
integrationOsRouter.post('/events', async (req: Request, res: Response) => {
...
integrationOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
