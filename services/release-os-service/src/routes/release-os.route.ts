...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/release-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/release-os.schemas.js';

export const releaseOsRouter = Router();

releaseOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
releaseOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
releaseOsRouter.post('/records', async (req: Request, res: Response) => {
...
releaseOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
releaseOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
releaseOsRouter.post('/events', async (req: Request, res: Response) => {
...
releaseOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
