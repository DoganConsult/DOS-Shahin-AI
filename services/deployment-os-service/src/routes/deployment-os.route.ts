...
import { listRecords, getRecord, createRecord, publishRecord, listEvents, emitEvent , evaluateRecord} from '../lib/deployment-os-repo.js';
import { RecordCreateSchema, RecordPublishSchema, EventEmitSchema } from '../schemas/deployment-os.schemas.js';

export const deploymentOsRouter = Router();

deploymentOsRouter.get('/records', async (req: Request, res: Response) => {
  try {
...
deploymentOsRouter.get('/records/:record_key', async (req: Request, res: Response) => {
  try {
...
deploymentOsRouter.post('/records', async (req: Request, res: Response) => {
...
deploymentOsRouter.post('/records/publish', async (req: Request, res: Response) => {
...
deploymentOsRouter.get('/events', async (req: Request, res: Response) => {
  try {
...
deploymentOsRouter.post('/events', async (req: Request, res: Response) => {
...
deploymentOsRouter.post('/records/:record_key/evaluate', async (req: Request, res: Response) => {
  try {
