...
exports.requireGatewayOrigin = exports.verifyGatewayOrigin = exports.GATEWAY_ORIGIN_HEADER = void 0;
...
function verifyGatewayOrigin(rawToken, options) {
    ...
    const expectedSig = node_crypto_1.default.createHmac('sha256', options.secret).update(payloadB64).digest();
    let providedSig;
    try {
 ...
 */
function requireGatewayOrigin(opts = {}) {
    ...
    return (req, res, next) => {
        const rawToken = req.headers[exports.GATEWAY_ORIGIN_HEADER];
