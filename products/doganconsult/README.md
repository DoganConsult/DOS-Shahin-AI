# products/doganconsult — Doganconsult
...
- ✅ `productCode: "doganconsult"` is registered in the platform's product layer.
...
The Doganconsult surface (the consulting brand). Detailed scope, tenant
...
|---|----------|------|--------|
| 1 | App scaffold | `products/doganconsult/app/` | ❌ |
| 2 | Website scaffold (optional) | `products/doganconsult/website/` | ❌ |
...
| 6 | Dynamic-UI enrollment file | `products/doganconsult/dynamic-ui/enrollment.json` | ❌ |
| 7 | Agent enrollment file | `products/doganconsult/agents/enrollment.json` | ❌ |
| 8 | `package.json` (when `app/` lands) | `products/doganconsult/app/package.json` | ❌ |
...
`productCode: "doganconsult"` — kebab-case per
