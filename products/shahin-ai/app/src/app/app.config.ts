...
// @dos/ui-os-client removed — package not yet wired in workspace. UI-OS API
// calls go through DynamicUiBootstrapService + /api/ui-os/* endpoints directly.
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // @dos/ui-os-client — removed until package is wired in workspace.
    // UI-OS API calls go through DynamicUiBootstrapService directly.
