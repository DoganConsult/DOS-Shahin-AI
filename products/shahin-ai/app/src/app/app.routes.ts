      ...
      },
      {
        ...
        children: [
          { path: '', pathMatch: 'full', redirectTo: 'overview' },
          {
            ...
            data: { contractRoute: '/risk/overview', moduleCode: 'risk', componentKey: 'module.overview.page', permission: 'risk.record.read', kpiScope: 'module-overview' },
          },
          {
            path: 'register',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
          ...
          },
          {
            path: 'assessments',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/assessments', moduleCode: 'risk', componentKey: 'RiskAssessmentsPage', permission: 'risk.assessment.create' },
          },
          {
            path: 'heatmap',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/heatmap', moduleCode: 'risk', componentKey: 'RiskHeatmapPage', permission: 'risk.record.read' },
          },
          {
            path: 'treatments',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/treatments', moduleCode: 'risk', componentKey: 'RiskTreatmentsPage', permission: 'risk.treatment.assign' },
          },
          {
            path: 'records',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/records', moduleCode: 'risk', componentKey: 'module.records.page', permission: 'risk.record.read' },
          },
          {
            path: 'workflows',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/workflows', moduleCode: 'risk', componentKey: 'module.workflows.page', permission: 'risk.manage' },
          },
          {
            path: 'reports',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/reports', moduleCode: 'risk', componentKey: 'module.reports.page', permission: 'risk.record.read' },
          },
          {
            path: 'settings',
            loadComponent: () => import('@platform/shell').then(m => m.DynamicTemplatePageComponent),
            data: { contractRoute: '/risk/settings', moduleCode: 'risk', componentKey: 'module.settings.page', permission: 'risk.manage' },
          },
        ],
      },
      {
