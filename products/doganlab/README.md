...
- ✅ `productCode: "doganlab"` is registered in the platform's product layer.
...
The Doganlab surface (R&D / labs sandbox brand). Detailed scope, tenant
...
|---|----------|------|--------|
| 1 | App scaffold | `products/doganlab/app/` | ❌ |
| 2 | Website scaffold (optional) | `products/doganlab/website/` | ❌ |
...
| 6 | Dynamic-UI enrollment file | `products/doganlab/dynamic-ui/enrollment.json` | ❌ |
| 7 | Agent enrollment file | `products/doganlab/agents/enrollment.json` | ❌ |
| 8 | `package.json` (when `app/` lands) | `products/doganlab/app/package.json` | ❌ |
...
`productCode: "doganlab"` — kebab-case per
