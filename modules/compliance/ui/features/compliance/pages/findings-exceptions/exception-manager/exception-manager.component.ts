...
@Component({
    ...
    <div class="page-shell">
      <div class="page-header">
        <div class="title-row">
          <div class="icon-wrap" style="background: var(--yellow-50, #f0f9ff)">
            <i class="" style="color: var(--yellow-500)"></i>
          </div>
          <div>
            <h1>Exception Manager</h1>
            <p class="subtitle">Manage compliance exceptions with approval workflows</p>
          </div>
        </div>
  ...
  `,
    ...
    .item-icon { width: 36px; height: 36px; border-radius: var(--radius); background: var(--yellow-50, #f0f9ff); display: flex; align-items: center; justify-content: center; }
    .item-icon i { font-size: var(--font-size-md); color: var(--yellow-500); }
