/**
 * NcaAssessmentScoringComponent — Dumb presentational component
 * Renders the NCA ECC assessment results dashboard: KPI row,
...
@Component({
  selector: 'app-nca-assessment-scoring',
  standalone: true,
    ...
    <div class="results-step" *ngIf="assessment">
      ...
      <table cdsTable aria-label="Data table" [value]="gapItems" [paginator]="true" [rows]="15" [rowsPerPageOptions]="[10,15,25,50]"
        ...
        <ng-template pTemplate="header">
          <tr>
            <th >{{ i18n.translate('ncaAssessment.code') }}</th>
            <th>{{ i18n.translate('ncaAssessment.control') }}</th>
            <th >{{ i18n.translate('ncaAssessment.priority') }}</th>
      ...
      <div class="step-actions">
        <button cdsButton [label]="i18n.translate('ncaAssessment.editAssessment')"
                  icon="" (onClick)="editRequested.emit()" styleClass="" />
        <button cdsButton [label]="i18n.translate('ncaAssessment.backToList')"
