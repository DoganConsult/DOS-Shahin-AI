...
import {
  ...
  generateReminders,
} from '../../../services/audit/operations/audit-reminders.service.js';
...
import { generateRemindersBody } from "../../../schemas/audit.schemas.js";
...
router.post("/generate", authenticate, requirePermission("audit.record.manage"), validate({ body: generateRemindersBody }), async (req: Request, res: Response) => {
  ...
  setAuditData(req, { action: "create", entityType: "reminder_generation", afterState: result });
