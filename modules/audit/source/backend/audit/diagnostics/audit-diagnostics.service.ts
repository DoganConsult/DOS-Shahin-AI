/**
 * AuditDiagnosticsService — production health checks (Rule 6.1)
 */
...
export async function runAuditDiagnostics(tenantId: string): Promise<DiagnosticsReport> {
  ...
  try {
    ...
    checks.push({
      ...
      details: `Found ${cnt} audit tables`,
    });
  } catch {
...
export { runAuditDiagnostics as runDiagnostics };
