...
import { ACTION_PERMISSIONS, ACTION_ROLES, ACTION_ACTIONS } from './security/action.security';
import { ACTION_APPROVAL_MATRIX } from './security/action.approval-matrix';

export const ACTION_MANIFEST: ModuleManifest = {
  code: 'action',
  version: '2.0.0',
  aliases: [],
  nameEn: 'Action Items',
  ...
  securityPermissions: ACTION_PERMISSIONS,
  securityRoles: ACTION_ROLES,
  securityActions: ACTION_ACTIONS,
  approvalRules: ACTION_APPROVAL_MATRIX,
  ownershipRules: [
...
registerModule(ACTION_MANIFEST);
