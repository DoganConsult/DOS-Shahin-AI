...
vi.mock('./privacy-event.service', () => ({
  emitPrivacyEvent: vi.fn(),
}));
...
vi.mock('../ports/database.port', () => ({
  ...
  describe('executeTransition', () => {
    it('should execute valid transitions', async () => {
      const r = await executeTransition('t1', 'e1', 'draft', 'submitted', 'u1');
