...
exports.getOrphanReport = getOrphanReport;
exports.getClassificationReport = getClassificationReport;
exports.getDashboardSummary = getDashboardSummary;
const database_port_1 = require("../ports/database.port");
async function getCoverageReport(tenantId) {
...
async function getOrphanReport(tenantId) {
    const ts = (0, database_port_1.tenantSchema)(tenantId);
    // Assets with no controls, no risks, no owner
    const { rows: orphanAssets } = await (0, database_port_1.safeQuery)(`
  ...
  `);
    ...
    const { rows: orphanApps } = await (0, database_port_1.safeQuery)(`
...
async function getClassificationReport(tenantId) {
    const ts = (0, database_port_1.tenantSchema)(tenantId);
    const { rows } = await (0, database_port_1.safeQuery)(`
    SELECT
...
//# sourceMappingURL=asset-reports.service.js.map