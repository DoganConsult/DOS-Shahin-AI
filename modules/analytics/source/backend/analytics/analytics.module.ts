...
import { ANALYTICS_PERMISSIONS, ANALYTICS_ROLES, ANALYTICS_ACTIONS } from './security/analytics.security';
import { ANALYTICS_APPROVAL_MATRIX } from './security/analytics.approval-matrix';
import { ANALYTICS_PUBLISHED_EVENTS, ANALYTICS_CONSUMED_EVENTS } from './events/analytics.events';

export const ANALYTICS_MANIFEST: ModuleManifest = {
  code: 'analytics',
  version: '2.0.0',
  aliases: [],
  nameEn: 'Analytics',
  ...
  publishedEvents: ANALYTICS_PUBLISHED_EVENTS,
  consumedEvents: ANALYTICS_CONSUMED_EVENTS,
  hardDeps: [],
  ...
  securityPermissions: ANALYTICS_PERMISSIONS,
  securityRoles: ANALYTICS_ROLES,
  securityActions: ANALYTICS_ACTIONS,
  approvalRules: ANALYTICS_APPROVAL_MATRIX,
  ownershipRules: [
...
registerModule(ANALYTICS_MANIFEST);
