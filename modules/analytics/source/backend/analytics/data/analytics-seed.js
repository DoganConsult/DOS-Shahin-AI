...
exports.getAnalyticsSeedData = getAnalyticsSeedData;
exports.seedAnalyticsModule = seedAnalyticsModule;
...
function getAnalyticsSeedData() {
    return {
        defaultConfigs: {
            moduleCode: 'analytics',
            autoArchiveEnabled: true,
            autoArchiveAfterDays: analytics_constants_1.ANALYTICS_TIMEOUTS.AUTO_ARCHIVE_AFTER_DAYS,
            defaultVisibility: 'org',
            notificationsEnabled: true,
            aiAssistEnabled: true,
            workflowEnabled: true,
            maxItemsPerPage: analytics_constants_1.ANALYTICS_LIMITS.MAX_ITEMS_PER_PAGE,
            maxTagsPerDashboard: analytics_constants_1.ANALYTICS_LIMITS.MAX_TAGS,
            maxFiltersPerSearch: analytics_constants_1.ANALYTICS_LIMITS.MAX_FILTERS,
            maxDataSourcesPerWidget: analytics_constants_1.ANALYTICS_LIMITS.MAX_DATA_SOURCES,
            maxExportRows: analytics_constants_1.ANALYTICS_LIMITS.MAX_EXPORT_ROWS,
            staleDashboardDays: analytics_constants_1.ANALYTICS_BUSINESS_THRESHOLDS.STALE_REPORT_DAYS,
            refreshWarningHours: analytics_constants_1.ANALYTICS_BUSINESS_THRESHOLDS.REFRESH_WARNING_HOURS,
            defaultRefreshIntervalMinutes: analytics_constants_1.ANALYTICS_TIMEOUTS.CACHE_TTL_MINUTES,
            generationTimeoutSeconds: analytics_constants_1.ANALYTICS_TIMEOUTS.GENERATION_TIMEOUT_SECONDS,
...
async function seedAnalyticsModule(tenantId, schema) {
    ...
    for (const [key, value] of Object.entries(data.defaultConfigs)) {
       ...
       VALUES ($1, $2, $3, $4)
       ON CONFLICT (module_code, config_key, tenant_id) DO NOTHING`, ['analytics', key, JSON.stringify(value), tenantId]).catch((0, resilience_1.catchHandler)(resilience_1.EC.EVENT_BUS));
    }
}
//# sourceMappingURL=analytics-seed.js.map