...
import { query as _query, tenantSchema as _tenantSchema } from '../ports/database.port';
import {
  WidgetDataEnvelope,
  RiskHeatmapData as _RiskHeatmapData,
  ComplianceTrendData as _ComplianceTrendData,
  VendorBubbleData as _VendorBubbleData,
  MaturityRadarData as _MaturityRadarData,
  FindingsBarData as _FindingsBarData,
  EvidenceDonutData as _EvidenceDonutData,
  ControlSankeyData as _ControlSankeyData,
} from '@dos/types';
...
function cacheKey(tenantId: string, widgetId: string, filters?: Record<string, unknown>): string {
...
import * as widgetData from './widget-data.service';
import * as insight from '../modules/widgets/insight-widgets.service';
...
const widgetFetchers: Record<string, (tenantId: string) => Promise<unknown>> = {
...
export async function queryBatchWidgetData(
  tenantId: string,
  widgetIds: string[],
  filters?: Record<string, unknown>
): Promise<Record<string, WidgetDataEnvelope>> {
  const results: Record<string, WidgetDataEnvelope> = {};
