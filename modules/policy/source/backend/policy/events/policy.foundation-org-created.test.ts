/**
 * Phase 5 — policy subscriber for foundation.org_created (F-040).
 */
...
describe('Phase 5 policy ← foundation.org_created', () => {
  ...
  it('creates one inheritance seed task per event', async () => {
