...
export function setLifecycleRegistry(impl) {
    _lifecycle = impl;
...
export function registerLifecycleDefinition(moduleCodeOrDefinition, entityType, states, transitions, opts) {
...
export function getDefinition(moduleCode, entityType) {
...
export function getRegistryEntry(moduleCode, entityType) {
...
export function isTransitionValid(moduleCode, entityType, from, to) {
    const impl = getLifecycle();
...
export function isTerminalState(moduleCode, entityType, state) {
    const impl = getLifecycle();
 ...
 */
export function canTransition(moduleCode, entityType, from, to) {
    if (from === to)
        return false;
 ...
 */
export async function performTransition(entityId, fromState, toState, moduleCode, entityType, opts) {
 ...
 */
export function getTransitionPermission(moduleCode, entityType, from, to) {
