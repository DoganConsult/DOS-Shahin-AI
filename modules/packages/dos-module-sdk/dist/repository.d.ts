 ...
 */
export interface Repository<T, ID = string, CreateDTO = Omit<T, 'id' | 'createdAt' | 'updatedAt'>, UpdateDTO = Partial<CreateDTO>, Filter extends Record<string, unknown> = Record<string, unknown>> extends ReadRepository<T, ID, Filter> {
    /** Create a new entity */
