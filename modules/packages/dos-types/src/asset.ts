...
export interface AssetInventoryStats {
  ...
  cloudVsOnPrem: { cloud: number; onPrem: number; colocated: number };
...
export const ASSET_STATUSES: readonly AssetStatus[] = ['discovered', 'registered', 'classified', 'active', 'decommissioning', 'decommissioned', 'archived'] as const;

export type AssetSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';

export const ASSET_SOURCES: readonly AssetSource[] = ['manual', 'import', 'api', 'workflow', 'ai_agent', 'system'] as const;
