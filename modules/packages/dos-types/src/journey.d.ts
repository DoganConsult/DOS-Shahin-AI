...
export interface GrcTermDefinition {
    term?: string;
    definition?: string;
    category?: string;
    [k: string]: unknown;
...
export interface GrcHealthReport {
...
export interface JourneyCompanyProfile {
    size?: string;
    sector?: string;
    country?: string;
    maturity?: string;
