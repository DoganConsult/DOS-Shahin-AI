...
export const REPORTING_STATUSES: readonly ReportingStatus[] = ['draft', 'generating', 'generated', 'published', 'distributed', 'archived'] as const;

export type ReportingSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';

export const REPORTING_SOURCES: readonly ReportingSource[] = ['manual', 'import', 'api', 'workflow', 'ai_agent', 'system'] as const;
