 ...
 */
export type DSARType = 'access' | 'rectification' | 'erasure' | 'restriction' | 'portability' | 'objection' | 'opt_out' | 'automated_decision' | 'complaint';
export type DSARStatus = 'received' | 'identity_verification' | 'assessment' | 'fulfillment' | 'pending_approval' | 'completed' | 'rejected' | 'withdrawn' | 'extended' | 'overdue';
...
export type ConsentPurpose = 'marketing' | 'analytics' | 'personalization' | 'functional' | 'security' | 'research' | 'third_party_sharing' | 'profiling' | 'custom';
...
export declare const PRIVACY_STATUSES: readonly PrivacyStatus[];
export type PrivacySource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';
export declare const PRIVACY_SOURCES: readonly PrivacySource[];
