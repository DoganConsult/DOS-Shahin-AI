 ...
 */
export type RegulatoryBodyType = 'financial_regulator' | 'data_protection' | 'telecommunications' | 'cybersecurity' | 'environmental' | 'health_safety' | 'competition' | 'securities' | 'insurance' | 'banking' | 'customs' | 'other';
...
export type LegalEntityType = 'corporation' | 'llc' | 'partnership' | 'sole_proprietorship' | 'branch' | 'subsidiary' | 'joint_venture' | 'trust' | 'ngo' | 'government' | 'other';
...
export type SanctionsList = 'ofac_sdn' | 'eu_sanctions' | 'un_sanctions' | 'uk_sanctions' | 'fatf_black' | 'fatf_grey' | 'interpol' | 'world_bank_debarment' | 'pep' | 'adverse_media';
...
export type MonitoringAlertType = 'new_regulation' | 'amendment' | 'enforcement_action' | 'guidance_issued' | 'consultation' | 'deadline_reminder' | 'industry_news';
