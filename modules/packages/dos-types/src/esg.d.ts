...
export type EmissionCategory = 'stationary_combustion' | 'mobile_combustion' | 'process_emissions' | 'fugitive_emissions' | 'purchased_electricity' | 'purchased_heat' | 'business_travel' | 'employee_commuting' | 'supply_chain' | 'waste' | 'water' | 'other';
...
export interface SocialMetric {
    ...
    tenantId: string;
    year: number;
    category: 'diversity_inclusion' | 'employee_wellbeing' | 'health_safety' | 'community' | 'human_rights' | 'supply_chain_labor' | 'data_privacy';
    indicator: string;
    value: number;
    unit?: string;
    benchmark?: number;
