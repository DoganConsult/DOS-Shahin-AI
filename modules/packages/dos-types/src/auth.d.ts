...
export type SecurityEventType = 'login_success' | 'login_failure' | 'mfa_challenge' | 'mfa_success' | 'mfa_failure' | 'session_revoked' | 'password_reset_requested' | 'password_reset_completed' | 'role_assigned' | 'role_revoked' | 'delegation_created' | 'delegation_revoked' | 'sod_violation' | 'access_denied' | 'brute_force_detected' | 'account_locked' | 'invitation_sent' | 'invitation_accepted';
