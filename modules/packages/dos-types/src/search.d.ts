 ...
 */
export type SearchEntityType = 'risk' | 'control' | 'finding' | 'evidence' | 'task' | 'incident' | 'policy' | 'vendor' | 'asset' | 'user' | 'document' | 'compliance_item' | 'workflow' | 'module' | 'any';
...
export type GRCQueryOperator = 'eq' | 'neq' | 'gt' | 'gte' | 'lt' | 'lte' | 'in' | 'nin' | 'contains' | 'starts_with' | 'ends_with' | 'is_null' | 'is_not_null' | 'between' | 'regex';
