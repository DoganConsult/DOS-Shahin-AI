...
export const TRAINING_STATUSES: readonly TrainingStatus[] = ['draft', 'published', 'active', 'in_progress', 'completed', 'expired', 'archived'] as const;

export type TrainingSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';

export const TRAINING_SOURCES: readonly TrainingSource[] = ['manual', 'import', 'api', 'workflow', 'ai_agent', 'system'] as const;
