 ...
 */
export type IncidentStatus = 'new' | 'triage' | 'investigating' | 'containment' | 'eradication' | 'recovery' | 'post_incident' | 'closed' | 'false_positive' | 'reported' | 'triaged' | 'contained' | 'eradicated' | 'recovered' | 'archived';
export type IncidentSeverity = 'critical' | 'high' | 'informational' | 'low' | 'medium';
export type IncidentCategory = 'data_breach' | 'unauthorized_access' | 'malware' | 'phishing' | 'dos_attack' | 'insider_threat' | 'policy_violation' | 'physical_security' | 'availability' | 'compliance_breach' | 'other';
...
export type AlertSource = 'siem' | 'ids_ips' | 'edr' | 'vulnerability_scanner' | 'compliance_engine' | 'cloud_guard' | 'waf' | 'dlp' | 'ueba' | 'custom';
...
export declare const INCIDENT_STATUSES: readonly IncidentStatus[];
export declare const INCIDENT_SEVERITIES: readonly IncidentSeverity[];
export type IncidentSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';
export declare const INCIDENT_SOURCES: readonly IncidentSource[];
