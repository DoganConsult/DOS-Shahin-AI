...
export type ChangeStatus = 'draft' | 'submitted' | 'review' | 'cab_pending' | 'approved' | 'scheduled' | 'in_progress' | 'completed' | 'failed' | 'cancelled' | 'rejected' | 'post_implementation_review';
export type ChangeCategory = 'infrastructure' | 'application' | 'security' | 'network' | 'database' | 'cloud' | 'client_device' | 'vendor_product' | 'business_process' | 'organizational' | 'other';
