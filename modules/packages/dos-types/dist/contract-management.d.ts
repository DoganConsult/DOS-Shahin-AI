 ...
 */
export type ContractType = 'nda' | 'msa' | 'sla' | 'sow' | 'purchase_order' | 'employment' | 'lease' | 'license' | 'partnership' | 'service_agreement' | 'data_processing' | 'regulatory' | 'insurance' | 'custom';
export type ContractStatus = 'draft' | 'in_review' | 'negotiation' | 'pending_signature' | 'active' | 'expiring_soon' | 'expired' | 'terminated' | 'cancelled' | 'archived';
...
export type ClauseType = 'payment' | 'liability' | 'indemnification' | 'termination' | 'intellectual_property' | 'confidentiality' | 'data_protection' | 'warranty' | 'dispute_resolution' | 'force_majeure' | 'sla_clause' | 'non_compete' | 'governing_law' | 'custom';
...
export type ObligationType = 'payment' | 'reporting' | 'compliance' | 'notification' | 'performance' | 'audit_right' | 'insurance' | 'regulatory' | 'custom';
