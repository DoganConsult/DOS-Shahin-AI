...
export type SupplierCategory = 'raw_materials' | 'components' | 'finished_goods' | 'services' | 'it_services' | 'logistics' | 'professional' | 'commodities' | 'other';
...
export type DisruptionType = 'geopolitical' | 'natural_disaster' | 'cyber_attack' | 'financial' | 'logistics' | 'regulatory' | 'pandemic' | 'labor' | 'quality' | 'other';
