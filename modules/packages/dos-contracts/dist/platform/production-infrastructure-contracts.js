...
exports.FROZEN_CONTRACTS = void 0;
exports.validateProductionContracts = validateProductionContracts;
exports.enforceProductionContracts = enforceProductionContracts;
const config_boundary_1 = require("./config-boundary");
exports.FROZEN_CONTRACTS = {
    C01_NETWORK: {
        id: 'C01',
    ...
    C02_PROXY: {
        ...
        rules: {
            requiredNginxHeaders: ['Host', 'X-Real-IP', 'X-Forwarded-For', 'X-Forwarded-Proto'],
    ...
    C03_RUNTIME_ROLE: {
        ...
        rules: {
            validRoles: config_boundary_1.VALID_SERVER_ROLES,
            validTopologies: config_boundary_1.VALID_TOPOLOGIES,
            processesPerServer: ['cloudflared', 'nginx', 'pm2', 'backend'],
            schedulerGating: {
    ...
    C09_DATABASE: {
        ...
        rules: {
            ...
            migrationOrder: ['master', 'tenant', 'dedicated-db-tenants'],
        },
    },
    C10_ROLLBACK: {
        id: 'C10',
        ...
        rules: {
            ...
            backupContents: ['backend-dist', 'frontend-browser', 'migrations', 'ecosystem.config.js'],
    ...
    C11_LOGGING: {
        ...
        rules: {
            ...
            validLogLevels: ['fatal', 'error', 'warn', 'info', 'debug', 'trace'],
    ...
    C12_SECURITY: {
        ...
        rules: {
            ...
            validAuthMatrixModes: ['off', 'shadow', 'enforce', 'dual'],
            productionAuthMatrixMode: 'enforce',
            rateLimitingPresent: true,
            noWeakJwtPatterns: ['dev-secret', 'change-me', 'secret', 'password', 'test', '123', 'default-key'],
    ...
    C13_GRACEFUL_SHUTDOWN: {
        ...
        rules: {
            ...
            resourceCleanupOrder: ['http-server', 'websocket', 'database', 'redis', 'langfuse'],
            pm2KillTimeout: 60000,
    ...
    C16_AI_PROVIDER: {
        ...
        rules: {
            ...
            validProviderModes: ['auto', 'anthropic', 'azure-openai', 'google', 'ollama', 'groq', 'openrouter'],
    ...
    C17_MULTI_TENANCY: {
        ...
        rules: {
            ...
            validIsolationModes: ['shared-schema', 'dedicated-schema', 'dedicated-db'],
            ...
            validDeploymentModes: ['saas_shared', 'saas_dedicated', 'on_prem'],
        },
    },
    C18_SECRETS: {
        id: 'C18',
        ...
        rules: {
            ...
            validSecretsModes: ['env-file', 'azure-keyvault', 'vault'],
    ...
    C19_BACKUP: {
        ...
        rules: {
            ...
            deployBackupContents: ['backend-dist', 'frontend-browser', 'migrations', 'ecosystem.config.js'],
    ...
    C28_PLATFORM_ENGINES: {
        ...
        rules: {
            formEngine: {
                ...
                files: ['form-schema.registry.ts', 'form-schema.routes.ts', 'form-schema.types.ts'],
            },
            taskEngine: {
                location: 'platform/task-engine',
                files: ['task-engine.ts'],
            },
            rulesEngine: {
                location: 'platform/rules',
                files: ['deterministic-rule-engine.ts'],
            },
    ...
    C29_DAUTH: {
        ...
        rules: {
            ...
            subsystems: ['access', 'actor', 'agents', 'audit', 'authority', 'contracts', 'delegation', 'frontend-contracts', 'identity'],
    ...
    C30_CONFIG_BOUNDARY: {
        ...
        rules: {
            ...
            validOwners: ['environment', 'deployment', 'tenant', 'workspace', 'product', 'onboarding', 'ai_provider', 'deprecated'],
...
function validateProductionContracts() {
    ...
    if (port !== exports.FROZEN_CONTRACTS.C01_NETWORK.rules.backendPort) {
        violations.push({
            contract: 'C01',
            rule: 'backendPort',
            expected: String(exports.FROZEN_CONTRACTS.C01_NETWORK.rules.backendPort),
            actual: String(port),
            fatal: true,
        });
    }
    const serverRole = process.env.SERVER_ROLE || 'web+jobs';
    if (!config_boundary_1.VALID_SERVER_ROLES.includes(serverRole)) {
        violations.push({
            contract: 'C03',
            rule: 'validRoles',
            expected: config_boundary_1.VALID_SERVER_ROLES.join(', '),
            actual: serverRole,
            fatal: true,
        });
    }
    const topology = process.env.PRODUCTION_TOPOLOGY || 'single-node';
    if (!config_boundary_1.VALID_TOPOLOGIES.includes(topology)) {
        violations.push({
            contract: 'C03',
            rule: 'validTopologies',
            expected: config_boundary_1.VALID_TOPOLOGIES.join(', '),
            actual: topology,
            fatal: true,
        });
    }
    ...
    const validLevels = exports.FROZEN_CONTRACTS.C11_LOGGING.rules.validLogLevels;
    ...
    const validAuthModes = exports.FROZEN_CONTRACTS.C12_SECURITY.rules.validAuthMatrixModes;
    ...
    const weakPatterns = exports.FROZEN_CONTRACTS.C12_SECURITY.rules.noWeakJwtPatterns;
    ...
    const validSecretsModes = exports.FROZEN_CONTRACTS.C18_SECRETS.rules.validSecretsModes;
    ...
    if (encryptionKey.length > 0 && encryptionKey.length < exports.FROZEN_CONTRACTS.C18_SECRETS.rules.minKeyLength) {
        violations.push({
            contract: 'C18',
            rule: 'minKeyLength',
            expected: `≥${exports.FROZEN_CONTRACTS.C18_SECRETS.rules.minKeyLength} characters`,
            actual: `${encryptionKey.length} characters`,
            fatal: true,
        });
    }
    const deploymentMode = process.env.DEPLOYMENT_MODE || 'saas_shared';
    const validDeployModes = exports.FROZEN_CONTRACTS.C17_MULTI_TENANCY.rules.validDeploymentModes;
...
function enforceProductionContracts(logger) {
...
//# sourceMappingURL=production-infrastructure-contracts.js.map