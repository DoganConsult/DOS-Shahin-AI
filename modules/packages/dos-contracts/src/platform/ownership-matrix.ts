...
// Backward-compat re-import for the CANONICAL_OWNERSHIP record key type.
// The ownership data is product-specific but the type contract is platform-owned.
...
const REGISTERED_MODULE_CODES = Object.freeze(
  Object.keys(CANONICAL_OWNERSHIP) as CanonicalModuleCode[],
);
