...
export type EventHandler<TPayload = unknown> = (event: PlatformEventEnvelope<TPayload>) => Promise<void>;
...
export interface DOSPort {
    ...
    subscribeEvent<TPayload>(eventType: string, subscriberId: string, handler: EventHandler<TPayload>): void;
