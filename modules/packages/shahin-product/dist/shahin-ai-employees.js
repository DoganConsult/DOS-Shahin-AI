...
exports.SHAHIN_AI_EMPLOYEES = void 0;
exports.getEmployeeRecord = getEmployeeRecord;
exports.listAllShifts = listAllShifts;
const HIRE_DATE_GA = '2026-04-28';
exports.SHAHIN_AI_EMPLOYEES = {
    A01: {
...
function getEmployeeRecord(agentId) {
    return exports.SHAHIN_AI_EMPLOYEES[agentId];
}
/** Helper: list every (agentId, shift) tuple — used by the cron seeder. */
function listAllShifts() {
    const out = [];
    for (const [agentId, record] of Object.entries(exports.SHAHIN_AI_EMPLOYEES)) {
        for (const shift of record.schedule)
            out.push({ agentId, shift });
    }
    return out;
}
//# sourceMappingURL=shahin-ai-employees.js.map