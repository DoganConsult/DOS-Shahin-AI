...
/**
 * Dora Diagnostics & Dashboard Routes
 * @owner dora
 * @module dora
 * @since 2026-03-31
 */
...
router.get('/diagnostics', authenticate, requirePermission('dora.record.read'), validate({ query: z.record(z.unknown()) }), asyncHandler(async (req: Request, res: Response) => {
