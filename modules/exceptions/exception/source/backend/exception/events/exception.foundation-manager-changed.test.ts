/**
 * Phase 2 — exception subscriber for foundation.org.manager.changed.
 */
...
import { getSubscriptionHandlers } from './exception.subscribers';

const { createProcessTaskMock } = mocks;

describe('Phase 2 exception ← foundation.org.manager.changed', () => {
  beforeEach(() => {
