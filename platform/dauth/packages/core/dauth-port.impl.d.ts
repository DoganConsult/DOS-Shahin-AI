 ...
 */
import type { DAuthAccessRequest, DAuthAccessResult, DAuthAuthorityCheck, DAuthDelegationContext, DAuthPort, DAuthPrincipal, DAuthSession, DAuthSoDResult } from '@dos/ports/dauth';
export interface DAuthPortDependencies {
    ...
    readonly getActiveDelegations: (principal: DAuthPrincipal) => Promise<readonly DAuthDelegationContext[]>;
    /** SoD conflict engine. */
    readonly evaluateSoD: (principal: DAuthPrincipal, proposedGrants: readonly {
        roleCode?: string;
 ...
 */
export declare function createDAuthPort(deps: DAuthPortDependencies): DAuthPort;
