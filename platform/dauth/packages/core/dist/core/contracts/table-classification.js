...
exports.DAUTH_TABLE_CLASSIFICATION = void 0;
exports.getDAuthBucket = getDAuthBucket;
exports.DAUTH_TABLE_CLASSIFICATION = {
...
function getDAuthBucket(tableName) {
    if (exports.DAUTH_TABLE_CLASSIFICATION.bucket1_runtime_truth.includes(tableName))
        return 1;
    if (exports.DAUTH_TABLE_CLASSIFICATION.bucket2_registry.includes(tableName))
        return 2;
    if (exports.DAUTH_TABLE_CLASSIFICATION.bucket3_presentation.includes(tableName))
        return 3;
    if (exports.DAUTH_TABLE_CLASSIFICATION.bucket4_provisioning.includes(tableName))
        return 4;
    if (exports.DAUTH_TABLE_CLASSIFICATION.bucket5_legacy.includes(tableName))
        return 5;
    return undefined;
}
//# sourceMappingURL=table-classification.js.map