...
exports.buildFrontendAccessContract = buildFrontendAccessContract;
exports.getMinimalAccessContract = getMinimalAccessContract;
exports.getNavigationContract = getNavigationContract;
exports.getPermissionContract = getPermissionContract;
exports.serializeAccessSnapshot = serializeAccessSnapshot;
exports.diffAccessContract = diffAccessContract;
 ...
 */
function computeContractHash(data) {
 ...
 */
function snapshotToContract(snapshot, versionHash) {
    return {
        version: versionHash,
 ...
 */
async function buildFrontendAccessContract(userId, tenantId) {
 ...
 */
async function getMinimalAccessContract(userId, tenantId) {
    const snapshot = await (0, access_snapshot_service_1.getAccessSnapshot)(tenantId, userId);
    const hashData = {
        permissions: snapshot.effectivePermissions,
        modules: snapshot.allowedModules,
 ...
 */
async function getNavigationContract(userId, tenantId) {
    const snapshot = await (0, access_snapshot_service_1.getAccessSnapshot)(tenantId, userId);
    const hashData = {
        modules: snapshot.allowedModules,
        dashboards: snapshot.allowedDashboards,
 ...
 */
async function getPermissionContract(userId, tenantId) {
    const snapshot = await (0, access_snapshot_service_1.getAccessSnapshot)(tenantId, userId);
    const hashData = {
        permissions: snapshot.effectivePermissions,
        decisionAuthorities: snapshot.decisionAuthorities ?? [],
 ...
 */
function serializeAccessSnapshot(snapshot) {
    const hashData = {
        permissions: snapshot.effectivePermissions,
        roles: snapshot.functionalRoles,
        modules: snapshot.allowedModules,
 ...
 */
function diffAccessContract(previous, current) {
    ...
    const hasChanges = previous.version !== current.version ||
 ...
 */
async function getContractVersion(userId, tenantId) {
    const snapshot = await (0, access_snapshot_service_1.getAccessSnapshot)(tenantId, userId);
    const hashData = {
        permissions: snapshot.effectivePermissions,
        roles: snapshot.functionalRoles,
...
//# sourceMappingURL=frontend-access-contract.service.js.map