...
export {
  ...
  type SodOutcome,
  type ActorPair,
  type AgentSodDecision,
} from '@dos/dauth-shared';

// PrincipalType is defined canonically at platform/dauth/packages/core/identity/identity.service.ts
// (already exported via dauth-core/index.ts:207). Re-export from there here for
// callers that imported it from this duplicate path.
