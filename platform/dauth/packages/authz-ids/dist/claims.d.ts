...
export interface CanonicalAccessTokenClaims {
    ...
    readonly resource_access?: Record<string, {
        roles: readonly string[];
    }>;
...
export declare const CANONICAL_SCOPES: {
    readonly openid: "openid";
    readonly profile: "profile";
    readonly email: "email";
    readonly offlineAccess: "offline_access";
    readonly groups: "groups";
    readonly realmRoles: "realm-roles";
};
export declare const CANONICAL_CLAIM_KEYS: readonly ["dos_user_id", "dos_tenant_id", "dos_workspace_id", "dos_product_code", "dos_role_profile", "dos_acr_required", "dos_risk_score", "dos_bootstrap_status"];
