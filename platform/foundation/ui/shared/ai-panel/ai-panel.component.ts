...
type I18nService = FoundationI18n;
...
export class AiPanelComponent {
  @Input() module: AIModule = 'risks';
  private _config: unknown;
  set config(v: unknown) {
    this._config = v;
    const module = (v as Record<string, unknown> | null | undefined)?.['module'];
    if (typeof module === 'string') this.module = module as AIModule;
  }
  get config(): unknown {
    return this._config;
  }
  ...
  constructor(@Inject(FOUNDATION_I18N) public i18n: I18nService, private http: HttpClient) {}
