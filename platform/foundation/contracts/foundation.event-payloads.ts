...
export type FoundationEventPayloadFor<E extends keyof FoundationEventPayloadMap> =
  FoundationEventPayloadMap[E];

/** Envelope wrapping any foundation event for transport. */
export interface FoundationEventEnvelope<
  E extends keyof FoundationEventPayloadMap = keyof FoundationEventPayloadMap,
> {
  eventId: string;
  eventName: E;
  eventVersion: number;
