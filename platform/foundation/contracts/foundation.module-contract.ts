...
export const FOUNDATION_CONTRACT: FoundationContract = {
  ...
  nav: [
    { pageCode: 'foundation.overview',         labelKey: 'modules.foundation.nav.overview',         icon: 'layout-dashboard', order: 10,  permission: 'foundation.module.read',    group: 'organization' },
    { pageCode: 'foundation.organization',     labelKey: 'modules.foundation.nav.organization',     icon: 'sitemap',          order: 20,  permission: 'foundation.data.read',      group: 'organization' },
    { pageCode: 'foundation.business-units',   labelKey: 'modules.foundation.nav.businessUnits',    icon: 'building',         order: 30,  permission: 'foundation.data.read',      group: 'organization' },
    { pageCode: 'foundation.departments',      labelKey: 'modules.foundation.nav.departments',      icon: 'users',            order: 40,  permission: 'foundation.data.read',      group: 'organization' },
    { pageCode: 'foundation.positions',        labelKey: 'modules.foundation.nav.positions',        icon: 'id-card',          order: 50,  permission: 'foundation.data.read',      group: 'organization' },
    { pageCode: 'foundation.locations',        labelKey: 'modules.foundation.nav.locations',        icon: 'map-pin',          order: 60,  permission: 'foundation.data.read',      group: 'organization' },
    ...
    { pageCode: 'foundation.teams',            labelKey: 'modules.foundation.nav.teams',            icon: 'users-group',      order: 80,  permission: 'foundation.data.read',      group: 'identity' },
    { pageCode: 'foundation.roles',            labelKey: 'modules.foundation.nav.roles',            icon: 'key',              order: 90,  permission: 'foundation.rbac.read',     group: 'identity' },
    { pageCode: 'foundation.permissions',      labelKey: 'modules.foundation.nav.permissions',      icon: 'shield-check',     order: 100, permission: 'foundation.rbac.read',     group: 'identity' },
    { pageCode: 'foundation.committees',       labelKey: 'modules.foundation.nav.committees',       icon: 'gavel',            order: 110, permission: 'foundation.data.read',      group: 'governance' },
    { pageCode: 'foundation.delegations',      labelKey: 'modules.foundation.nav.delegations',      icon: 'share',            order: 120, permission: 'foundation.data.read',      group: 'governance' },
    { pageCode: 'foundation.access-review',    labelKey: 'modules.foundation.nav.accessReview',     icon: 'clipboard-check',  order: 130, permission: 'foundation.review.read',   group: 'governance' },
    { pageCode: 'foundation.policies',         labelKey: 'modules.foundation.nav.policies',         icon: 'file-shield',      order: 140, permission: 'foundation.data.read',      group: 'governance' },
    { pageCode: 'foundation.audit',            labelKey: 'modules.foundation.nav.audit',            icon: 'history',          order: 150, permission: 'foundation.audit.read',    group: 'governance' },
    { pageCode: 'foundation.ownership',        labelKey: 'modules.foundation.nav.ownership',        icon: 'tag',              order: 160, permission: 'foundation.data.read',      group: 'governance' },
    { pageCode: 'foundation.sod',              labelKey: 'modules.foundation.nav.sod',              icon: 'shield-x',         order: 170, permission: 'foundation.sod.write',     group: 'governance' },
    { pageCode: 'foundation.hierarchy-viz',    labelKey: 'modules.foundation.nav.hierarchyViz',     icon: 'git-branch',       order: 180, permission: 'foundation.hierarchy.read', group: 'organization' },
    { pageCode: 'foundation.user-lifecycle',   labelKey: 'modules.foundation.nav.userLifecycle',    icon: 'activity',         order: 190, permission: 'foundation.user.write',    group: 'identity' },
    { pageCode: 'foundation.reference-data',   labelKey: 'modules.foundation.nav.referenceData',    icon: 'database',         order: 200, permission: 'foundation.data.read',      group: 'governance' },
    { pageCode: 'foundation.diagnostics',      labelKey: 'modules.foundation.nav.diagnostics',      icon: 'stethoscope',      order: 210, permission: 'foundation.module.read',    group: 'governance' },
  ],
