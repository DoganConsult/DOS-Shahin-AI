...
exports.grcSortDir = exports.idParam = exports.bulkIdsBody = exports.searchQuery = exports.grcPositiveInt = exports.grcJsonMetadata = exports.statusFilter = exports.paginationQuery = void 0;
/**
...
// Foundation-extended schemas
const zod_2 = require("zod");
exports.idParam = zod_2.z.object({ id: zod_2.z.string().min(1).max(128) });
exports.grcSortDir = zod_2.z.enum(['asc', 'desc']).optional().default('desc');
