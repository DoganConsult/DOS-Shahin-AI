...
import { FOUNDATION_PERMISSIONS, FOUNDATION_ROLES, FOUNDATION_ACTIONS } from './security/foundation.security';
import { FOUNDATION_APPROVAL_MATRIX } from './security/foundation.approval-matrix';

export const FOUNDATION_MANIFEST: ModuleManifest = {
  code: 'foundation',
  version: '2.0.0',
  aliases: [],
  ...
  securityPermissions: FOUNDATION_PERMISSIONS,
  securityRoles: FOUNDATION_ROLES,
  securityActions: FOUNDATION_ACTIONS,
  approvalRules: FOUNDATION_APPROVAL_MATRIX,
  ownershipRules: [
...
registerModule(FOUNDATION_MANIFEST);
