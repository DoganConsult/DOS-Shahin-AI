...
import { emptyResult, safeQuery, tenantSchema, query as dbQuery } from '@dos/db';
...
export async function rebootAgent(
  ...
  try {
    ...
    try {
      const { resetAgentCircuit } = await import('../../../modules/ai/services/orchestration/ai-agent-runtime.service.js');
