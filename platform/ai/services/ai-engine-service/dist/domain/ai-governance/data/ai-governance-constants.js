export const AI_GOVERNANCE_STATUSES = ['draft', 'assessment', 'review', 'approved', 'monitoring', 'non_compliant', 'retired', 'archived'];
export const AI_GOVERNANCE_DEFAULT_STATUS = 'draft';
export const AI_GOVERNANCE_TERMINAL_STATUSES = ['retired', 'archived'];
...
//# sourceMappingURL=ai-governance-constants.js.map