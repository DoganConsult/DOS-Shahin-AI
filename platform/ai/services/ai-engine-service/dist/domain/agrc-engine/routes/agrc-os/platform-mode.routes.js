...
router.get('/mode-operation-log', validate({ query: z.record(z.unknown()) }), authenticate, requirePermission('event.log.read'), async (req, res) => {
    try {
...
//# sourceMappingURL=platform-mode.routes.js.map