...
router.get('/sops', validate({ query: z.record(z.unknown()) }), authenticate, requirePermission('sop.document.read'), async (req, res) => {
...
router.post('/sops', authenticate, requirePermission('sop.document.write'), validateSOP, validate({ body: createSopsBody }), async (req, res) => {
...
router.delete('/sops/:sopId', validate({ body: genericPayloadSchema }), authenticate, requirePermission('sop.document.write'), async (req, res) => {
...
router.post('/sops/seed', authenticate, requirePermission('platform.agent.manage'), validate({ body: createSeedBody }), async (req, res) => {
...
router.post('/sops/:sopId/start', authenticate, requirePermission('sop.document.read'), validate({ body: createStartBody }), async (req, res) => {
...
router.put('/sops/completions/:completionId', authenticate, requirePermission('sop.document.read'), validate({ body: updateCompletionsBody }), async (req, res) => {
...
router.get('/sops/completions', validate({ query: z.record(z.unknown()) }), authenticate, requirePermission('sop.document.read'), async (req, res) => {
...
router.get('/sops/compliance-stats', validate({ query: z.record(z.unknown()) }), authenticate, requirePermission('sop.document.read'), async (req, res) => {
...
//# sourceMappingURL=sops-runbooks.routes.js.map