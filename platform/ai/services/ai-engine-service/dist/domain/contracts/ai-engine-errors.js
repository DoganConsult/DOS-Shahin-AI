...
export function buildAIEngineError(code, correlationId, detail) {
    return new AIEngineServiceError(code, correlationId, detail).toJSON();
}
export function throwAIEngineError(code, correlationId, detail) {
    throw new AIEngineServiceError(code, correlationId, detail);
}
//# sourceMappingURL=ai-engine-errors.js.map