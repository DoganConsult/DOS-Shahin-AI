...
export async function parseIntentToQuery(tenantId, userId, moduleCode, userQuery, language = 'en') {
    ...
    const columnsRes = await swallowDefault(EC.FALLBACK_QUERY, emptyResult(), safeQuery(`SELECT column_name, data_type 
       FROM information_schema.columns 
       WHERE table_schema = $1 AND table_name = $2`, [schema, safeTableName]), { tenantId, operation: `query_columns:${moduleCode}` });
    let schemaContext = '';
...
//# sourceMappingURL=intent-to-query.service.js.map