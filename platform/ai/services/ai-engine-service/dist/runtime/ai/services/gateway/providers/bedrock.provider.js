...
export async function callBedrockApi(config, messages, maxTokens, overrideModel) {
    let client;
    try {
        ...
        const bedrockModuleName = '@aws-sdk/client-bedrock-runtime';
        const mod = await import(bedrockModuleName);
        ...
        throw new Error(`[bedrock] Provider unavailable (install @aws-sdk/client-bedrock-runtime and set AWS credentials): ${err.message}`);
    }
}
