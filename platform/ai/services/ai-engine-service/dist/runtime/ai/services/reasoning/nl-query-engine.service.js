 ...
 */
export async function executeNLQuery(tenantId, query) {
    ...
    try {
        ...
        if (!generatedSql) {
            return {
                type: 'error',
                message: 'I could not generate a safe query for that question. Try asking about risks, controls, evidence, policies, findings, vendors, or compliance posture.',
            };
        }
 ...
 */
async function generateSafeSql(tenantId, query, schema) {
    try {
...
//# sourceMappingURL=nl-query-engine.service.js.map