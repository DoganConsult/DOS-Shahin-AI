export const AI_STATUSES = ['draft', 'in_review', 'approved', 'active', 'suspended', 'decommissioned', 'archived'] as const;

export const AI_DEFAULT_STATUS: typeof AI_STATUSES[number] = 'draft';

export const AI_TERMINAL_STATUSES = ['decommissioned', 'archived'] as const;
