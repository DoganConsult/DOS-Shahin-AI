...
export class AiAutoRepo {
  ...
  static async query500(schema: string, args: unknown[]) {
  ...
  static async query501(schema: string, args: unknown[]) {
  ...
  static async query502(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_invocations SET status = $1, updated_at = NOW() WHERE id = $2`;
    return safeQuery(query, args);
  }

  static async query503(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".event_trigger_binding
  ...
  static async query504(schema: string, args: unknown[]) {
  ...
  static async query505(schema: string, args: unknown[]) {
    const query = `SELECT COUNT(*)::int AS count FROM "${schema}".copilot_proposed_actions
       WHERE user_id = $1 AND status = 'pending'`;
    return safeQuery(query, args);
  }

  static async query506(schema: string, args: unknown[]) {
  ...
  static async query507(schema: string, args: unknown[]) {
  ...
  static async query508(schema: string, args: unknown[]) {
    const query = `SELECT team_id, team_name FROM "${schema}".teams WHERE team_code = $1 LIMIT 1`;
    return safeQuery(query, args);
  }

  static async query509(schema: string, args: unknown[]) {
  ...
  static async query510(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".copilot_proposed_actions
  ...
  static async query511(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".copilot_proposed_actions
  ...
  static async query512(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".copilot_proposed_actions
  ...
  static async query513(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".copilot_proposed_actions
  ...
  static async query514(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".copilot_proposed_actions
  ...
  static async query515(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".copilot_proposed_actions
  ...
  static async query521(schema: string, args: unknown[]) {
    const query = `SELECT scopes FROM "${schema}".delegation_grants WHERE grant_id = $1`;
    return safeQuery(query, args);
  }

  static async query522(schema: string, args: unknown[]) {
  ...
  static async query523(schema: string, args: unknown[]) {
  ...
  static async query524(schema: string, args: unknown[]) {
  ...
  static async query525(schema: string, args: unknown[]) {
  ...
  static async query526(schema: string, args: unknown[]) {
    const query = `SELECT 1 FROM "${schema}"."${mapping.table}" WHERE "${mapping.pk}" = $1 LIMIT 1`;
    return safeQuery(query, args);
  }

  static async query527(schema: string, args: unknown[]) {
    const query = `
  ...
  static async query528(schema: string, args: unknown[]) {
    const query = `DELETE FROM "${schema}".ai_agent_registry WHERE agent_version_id = $1`;
    return safeQuery(query, args);
  }

  static async query529(schema: string, args: unknown[]) {
  ...
  static async query533(schema: string, args: unknown[]) {
  ...
  static async query534(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_agent_registry
  ...
  static async query535(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_agent_registry
  ...
  static async query536(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_agent_registry
  ...
  static async query537(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_agent_registry
  ...
  static async query538(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_agent_registry SET ${sets.join(', ')} WHERE agent_version_id = $${idx} RETURNING *`;
    return safeQuery(query, args);
  }

  static async query539(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".ai_agent_registry
       (asset_id, version_number, agent_config, linked_prompt_asset_id, linked_model_asset_id,
  ...
  static async query540(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".ai_agent_registry
  ...
  static async query541(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".ai_agent_registry WHERE agent_version_id = $1`;
    return safeQuery(query, args);
  }

  static async query542(schema: string, args: unknown[]) {
  ...
  static async query543(schema: string, args: unknown[]) {
  ...
  static async query544(schema: string, args: unknown[]) {
  ...
  static async query545(schema: string, args: unknown[]) {
  ...
  static async query546(schema: string, args: unknown[]) {
  ...
  static async query547(schema: string, args: unknown[]) {
  ...
  static async query548(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".ai_agent_configs WHERE tenant_id = $1 AND agent_id = $2`;
    return safeQuery(query, args);
  }

  static async query549(schema: string, args: unknown[]) {
  ...
  static async query550(schema: string, args: unknown[]) {
  ...
  static async query551(schema: string, args: unknown[]) {
  ...
  static async query552(schema: string, args: unknown[]) {
  ...
  static async query553(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".agent_runtime_config WHERE tenant_id = $1 ORDER BY agent_id`;
    return safeQuery(query, args);
  }

  static async query554(schema: string, args: unknown[]) {
    const query = `SELECT
         COUNT(*) AS total,
  ...
  static async query555(schema: string, args: unknown[]) {
  ...
  static async query556(schema: string, args: unknown[]) {
  ...
  static async query557(schema: string, args: unknown[]) {
  ...
  static async query558(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".agent_runtime_config (tenant_id, agent_id, enabled, updated_by, updated_at)
       VALUES ($1, $2, $3, $4, NOW())
  ...
  static async query559(schema: string, args: unknown[]) {
  ...
  static async query560(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".agent_runtime_config WHERE tenant_id = $1 AND agent_id = $2`;
    return safeQuery(query, args);
  }

  static async query561(schema: string, args: unknown[]) {
  ...
  static async query562(schema: string, args: unknown[]) {
    const query = `SELECT compliance_score FROM "${schema}".kpi_snapshots
       ORDER BY snapshot_date DESC LIMIT 7`;
    return safeQuery(query, args);
  }

  static async query563(schema: string, args: unknown[]) {
  ...
  static async query564(schema: string, args: unknown[]) {
  ...
  static async query565(schema: string, args: unknown[]) {
  ...
  static async query566(schema: string, args: unknown[]) {
  ...
  static async query567(schema: string, args: unknown[]) {
  ...
  static async query568(schema: string, args: unknown[]) {
  ...
  static async query569(schema: string, args: unknown[]) {
  ...
  static async query570(schema: string, args: unknown[]) {
    const query = `SELECT * FROM instruments WHERE instrument_id = $1`;
    return safeQuery(query, args);
  }

  static async query571(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".incidents WHERE incident_id = $1`;
    return safeQuery(query, args);
  }

  static async query572(schema: string, args: unknown[]) {
  ...
  static async query573(schema: string, args: unknown[]) {
    const query = `SELECT name_en, name_ar FROM instruments WHERE instrument_id = $1`;
    return safeQuery(query, args);
  }

  static async query574(schema: string, args: unknown[]) {
    const query = `SELECT org_name, industry FROM tenants WHERE tenant_id = $1`;
    return safeQuery(query, args);
  }

  static async query575(schema: string, args: unknown[]) {
  ...
  static async query576(schema: string, args: unknown[]) {
  ...
  static async query577(schema: string, args: unknown[]) {
    const query = `SELECT * FROM "${schema}".risks WHERE risk_id = $1`;
    return safeQuery(query, args);
  }

  static async query578(schema: string, args: unknown[]) {
    const query = `SELECT success_metric, min_sample_size FROM "${schema}".agent_ab_tests
     WHERE id = $1 AND tenant_id = $2`;
    return safeQuery(query, args);
  }

  static async query579(schema: string, args: unknown[]) {
  ...
  static async query580(schema: string, args: unknown[]) {
    const query = `SELECT success_metric FROM "${schema}".agent_ab_tests
     WHERE id = $1 AND tenant_id = $2`;
    return safeQuery(query, args);
  }

  static async query581(schema: string, args: unknown[]) {
  ...
  static async query582(schema: string, args: unknown[]) {
  ...
  static async query583(schema: string, args: unknown[]) {
    const query = `SELECT split_ratio FROM "${schema}".agent_ab_tests
     WHERE id = $1 AND tenant_id = $2 AND status = 'active'`;
    return safeQuery(query, args);
  }

  static async query584(schema: string, args: unknown[]) {
  ...
  static async query585(schema: string, args: unknown[]) {
  ...
  static async query586(schema: string, args: unknown[]) {
    const query = `SELECT
         f.agent_id,
  ...
  static async query587(schema: string, args: unknown[]) {
    const query = distQ;
    return safeQuery(query, args);
  }

  static async query588(schema: string, args: unknown[]) {
    const query = q;
    return safeQuery(query, args);
  }

  static async query589(schema: string, args: unknown[]) {
  ...
  static async query590(schema: string, args: unknown[]) {
  ...
  static async query591(schema: string, args: unknown[]) {
    const query = q;
    return safeQuery(query, args);
  }

  static async query592(schema: string, args: unknown[]) {
    const query = `SELECT inputs_ref, outputs_ref FROM "${schema}".agent_steps
         WHERE run_id = $1 AND status = 'done' LIMIT 3`;
    return safeQuery(query, args);
  }

  static async query593(schema: string, args: unknown[]) {
  ...
  static async query594(schema: string, args: unknown[]) {
  ...
  static async query595(schema: string, args: unknown[]) {
    const query = `SELECT 
  ...
  static async query599(schema: string, args: unknown[]) {
    const query = `SELECT DISTINCT agent_id FROM "${schema}".agent_tasks WHERE tenant_id = $1`;
    return safeQuery(query, args);
  }

  static async query600(schema: string, args: unknown[]) {
    const query = `SELECT MAX(created_at) as last_event FROM "${schema}".agent_learning_events WHERE agent_id = $1`;
    return safeQuery(query, args);
  }

  static async query601(schema: string, args: unknown[]) {
    const query = `SELECT COUNT(*) as count FROM "${schema}".agent_lessons_learned WHERE agent_id = $1`;
    return safeQuery(query, args);
  }

  static async query602(schema: string, args: unknown[]) {
  ...
  static async query603(schema: string, args: unknown[]) {
  ...
  static async query604(schema: string, args: unknown[]) {
  ...
  static async query605(schema: string, args: unknown[]) {
    const query = `SELECT 
  ...
  static async query606(schema: string, args: unknown[]) {
  ...
  static async query607(schema: string, args: unknown[]) {
  ...
  static async query611(schema: string, args: unknown[]) {
  ...
  static async query612(schema: string, args: unknown[]) {
    const query = query;
    return safeQuery(query, args);
  }

  static async query613(schema: string, args: unknown[]) {
  ...
  static async query617(schema: string, args: unknown[]) {
  ...
  static async query618(schema: string, args: unknown[]) {
  ...
  static async query619(schema: string, args: unknown[]) {
  ...
  static async query620(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".frameworks (framework_id, name, description, category, total_controls)
  ...
  static async query625(schema: string, args: unknown[]) {
  ...
  static async query626(schema: string, args: unknown[]) {
  ...
  static async query627(schema: string, args: unknown[]) {
  ...
  static async query628(schema: string, args: unknown[]) {
  ...
  static async query629(schema: string, args: unknown[]) {
  ...
  static async query630(schema: string, args: unknown[]) {
  ...
  static async query631(schema: string, args: unknown[]) {
  ...
  static async query632(schema: string, args: unknown[]) {
    const query = `SELECT COUNT(*)::int AS n FROM "${schema}".policies
  ...
  static async query636(schema: string, args: unknown[]) {
    const query = `SELECT COUNT(*)::int AS n FROM "${schema}".ucf_controls c
       WHERE NOT EXISTS (
         SELECT 1 FROM "${schema}".evidence e
  ...
  static async query639(schema: string, args: unknown[]) {
  ...
  static async query640(schema: string, args: unknown[]) {
    const query = `SELECT COUNT(*)::int AS n FROM "${schema}".frameworks WHERE deleted_at IS NULL`;
    return safeQuery(query, args);
  }

  static async query641(schema: string, args: unknown[]) {
  ...
  static async query642(schema: string, args: unknown[]) {
  ...
  static async query643(schema: string, args: unknown[]) {
  ...
  static async query644(schema: string, args: unknown[]) {
    const query = `SELECT agent_id, state, failure_count, success_count, last_failure_at, last_success_at, opened_at, total_calls, total_failures
       FROM "${schema}".agent_circuit_breaker
       WHERE agent_id = $1`;
    return safeQuery(query, args);
  ...
  static async query645(schema: string, args: unknown[]) {
  ...
  static async query646(schema: string, args: unknown[]) {
    const query = `SELECT
           COUNT(*)::int AS total,
           COUNT(*) FILTER (WHERE status = 'open')::int AS open,
           COUNT(*) FILTER (WHERE status = 'acknowledged')::int AS acknowledged,
  ...
  static async query647(schema: string, args: unknown[]) {
  ...
  static async query648(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_alerts
  ...
  static async query649(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_alerts
  ...
  static async query650(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_alerts
  ...
  static async query651(schema: string, args: unknown[]) {
  ...
  static async query655(schema: string, args: unknown[]) {
    const query = `SELECT payload FROM "${schema}".agrc_event_log
  ...
  static async query656(schema: string, args: unknown[]) {
  ...
  static async query657(schema: string, args: unknown[]) {
  ...
  static async query658(schema: string, args: unknown[]) {
  ...
  static async query659(schema: string, args: unknown[]) {
  ...
  static async query660(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".agrc_event_log (event_type, payload, severity, source_service)
       VALUES ('ai_audit_anomaly_report', $1, $2, 'platform')`;
    return safeQuery(query, args);
  }

  static async query661(schema: string, args: unknown[]) {
    const query = query;
    return safeQuery(query, args);
  }

  static async query662(schema: string, args: unknown[]) {
  ...
  static async query663(schema: string, args: unknown[]) {
  ...
  static async query664(schema: string, args: unknown[]) {
  ...
  static async query665(schema: string, args: unknown[]) {
    const query = query;
    return safeQuery(query, args);
  }

  static async query666(schema: string, args: unknown[]) {
  ...
  static async query667(schema: string, args: unknown[]) {
  ...
  static async query668(schema: string, args: unknown[]) {
  ...
  static async query669(schema: string, args: unknown[]) {
  ...
  static async query670(schema: string, args: unknown[]) {
    const query = `SELECT rc.control_code, rc.control_title_en, rc.control_description_en,
            rc.criticality_level, cd.domain_name_en
     FROM public.regulatory_controls rc
     JOIN public.control_domains cd ON cd.id = rc.domain_id
  ...
  static async query671(schema: string, args: unknown[]) {
  ...
  static async query672(schema: string, args: unknown[]) {
  ...
  static async query673(schema: string, args: unknown[]) {
    const query = query;
    return safeQuery(query, args);
  }

  static async query674(schema: string, args: unknown[]) {
  ...
  static async query675(schema: string, args: unknown[]) {
    const query = `UPDATE "${schema}".ai_dpia_assessments 
  ...
  static async query676(schema: string, args: unknown[]) {
  ...
  static async query677(schema: string, args: unknown[]) {
  ...
  static async query680(schema: string, args: unknown[]) {
  ...
  static async query689(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".agrc_event_log (event_type, payload, severity, source_service)
       VALUES ('rbac_drift_result', $1, $2, 'platform')`;
    return safeQuery(query, args);
  }

  static async query690(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".agrc_event_log (event_type, payload, severity, source_service)
       VALUES ('rbac_drift_report', $1, $2, 'platform')`;
    return safeQuery(query, args);
  }

  static async query691(schema: string, args: unknown[]) {
  ...
  static async query707(schema: string, args: unknown[]) {
    const query = `INSERT INTO "${schema}".agrc_event_log (event_type, payload, severity, source_service)
