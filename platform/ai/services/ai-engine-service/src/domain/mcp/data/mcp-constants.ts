...
export const MCP_BUSINESS_THRESHOLDS = {
  ...
  MAX_RETRIES: 3,
  RETRY_BACKOFF_MS: [1000, 5000, 15000] as readonly number[],
...
export const MCP_AUTONOMY_LEVELS = ['L0', 'L1', 'L2', 'L3'] as const;

export const MCP_RISK_LEVELS = ['low', 'medium', 'high', 'critical'] as const;
