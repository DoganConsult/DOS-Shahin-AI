...
export function getCodeSearchConfig(): Record<CodeSearchEngineName, CodeSearchEngineConfig> {
...
export function getEnabledEngines(): Array<CodeSearchEngineConfig & { engine: CodeSearchEngineName }> {
  const cfg = getCodeSearchConfig();
  return (Object.keys(cfg) as CodeSearchEngineName[])
