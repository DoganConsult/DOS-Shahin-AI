...
import { AiAgentApiService, AgentPerformanceDto, GovAIRecommendationDto } from '@app/core/services/workflow-collab/ai-agent-api.service';
...
@Component({
  ...
  `,
    ...
    .icon-wrap { width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; background: var(--purple-50, #faf5ff); }
    .icon-wrap i { font-size: 1.5rem; color: var(--purple-500, #a855f7); }
    h1 { margin: 0; font-size: 1.5rem; font-weight: 600; }
    .subtitle { margin: 2px 0 0; font-size: 0.875rem; color: var(--text-color-secondary); }
    .header-actions { display: flex; gap: 8px; }
    .btn-primary { display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; border: none; border-radius: 8px; background: var(--primary-500, #3b82f6); color: #fff; cursor: pointer; font-size: 0.875rem; font-weight: 500; }
    .btn-primary:hover { background: var(--primary-600); }
    .btn-outline { display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; border: 1px solid var(--surface-border); border-radius: 8px; background: var(--surface-card); cursor: pointer; font-size: 0.875rem; }
    ...
    .stat-card { background: var(--surface-card); border-radius: 10px; border: 1px solid var(--surface-border); padding: 14px 18px; text-align: center; }
    .stat-value { font-size: 1.5rem; font-weight: 700; display: block; }
    .stat-label { font-size: 0.75rem; color: var(--text-color-secondary); margin-top: 2px; display: block; }
    ...
    .chat-section { background: var(--surface-card); border-radius: 12px; border: 1px solid var(--surface-border); display: flex; flex-direction: column; min-height: 500px; max-height: 70vh; }
    .chat-messages { flex: 1; overflow-y: auto; padding: 20px; display: flex; flex-direction: column; gap: 12px; }
    .chat-welcome { text-align: center; padding: 40px 20px; color: var(--text-color-secondary); }
    .welcome-icon { font-size: 3rem; color: var(--purple-300); margin-bottom: 12px; }
    ...
    .chip { padding: 6px 14px; border-radius: 20px; border: 1px solid var(--surface-border); background: var(--surface-50); cursor: pointer; font-size: 0.8125rem; }
    .chip:hover { background: var(--primary-50); border-color: var(--primary-200); }
    .msg { display: flex; gap: 10px; max-width: 80%; }
    .msg-user { align-self: flex-end; flex-direction: row-reverse; }
    .msg-assistant { align-self: flex-start; }
    .msg-avatar { width: 32px; height: 32px; border-radius: 8px; background: var(--purple-50); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .msg-avatar i { font-size: 0.875rem; color: var(--purple-500); }
    .msg-bubble { padding: 10px 14px; border-radius: 12px; font-size: 0.875rem; line-height: 1.5; }
    ...
    .msg-meta { display: flex; align-items: center; gap: 8px; margin-top: 4px; font-size: 0.6875rem; opacity: 0.7; }
    .msg-time { font-size: 0.6875rem; }
    ...
    .chat-input { flex: 1; padding: 10px 14px; border: 1px solid var(--surface-border); border-radius: 10px; font-size: 0.875rem; outline: none; }
    .chat-input:focus { border-color: var(--primary-400); box-shadow: 0 0 0 2px var(--primary-50); }
    .send-btn { width: 40px; height: 40px; border-radius: 10px; border: none; background: var(--primary-500); color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; }
    ...
    .sidebar-card { background: var(--surface-card); border-radius: 12px; border: 1px solid var(--surface-border); padding: 16px; }
    .sidebar-card h3 { margin: 0 0 12px; font-size: 0.875rem; font-weight: 600; }
    .muted { font-size: 0.8125rem; color: var(--text-color-secondary); }
    .agent-row { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; font-size: 0.8125rem; }
    .agent-id { width: 32px; font-weight: 600; font-size: 0.75rem; color: var(--primary-600); }
    ...
    .agent-rate { width: 36px; text-align: end; font-size: 0.75rem; font-weight: 600; }
    .action-row { display: flex; align-items: center; gap: 8px; padding: 8px 0; border-bottom: 1px solid var(--surface-50); font-size: 0.8125rem; }
    .action-title { flex: 1; }
    .action-priority, .rec-priority { font-size: 0.6875rem; padding: 2px 8px; border-radius: 8px; font-weight: 600; text-transform: uppercase; }
    ...
    .icon-btn { width: 28px; height: 28px; border-radius: 6px; border: 1px solid var(--surface-border); background: transparent; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; }
    .icon-btn:hover { background: var(--surface-100); }
    .rec-row { display: flex; align-items: center; gap: 8px; padding: 8px 0; border-bottom: 1px solid var(--surface-50); font-size: 0.8125rem; }
    .rec-title { flex: 1; }
    .btn-sm { padding: 4px 10px; border-radius: 6px; border: 1px solid var(--primary-300); background: var(--primary-50); color: var(--primary-700); font-size: 0.6875rem; font-weight: 600; cursor: pointer; }
