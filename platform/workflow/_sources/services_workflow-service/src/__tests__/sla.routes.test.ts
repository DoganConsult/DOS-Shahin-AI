...
vi.mock('../events/publisher', () => ({
  ...
  publishApprovalApproved: vi.fn().mockResolvedValue(undefined),
  publishWorkflowCreated: vi.fn().mockResolvedValue(undefined),
...
import router from '../routes/sla.routes';
import * as domainSvc from '../domain/sla.service';
