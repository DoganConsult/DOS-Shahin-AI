/**
 * WorkflowDiagnosticsService — production health checks (Rule 6.1)
 */
...
export async function runWorkflowDiagnostics(tenantId: string): Promise<DiagnosticsReport> {
  ...
  try {
    ...
    checks.push({
      ...
      details: `Found ${cnt} workflow tables`,
    });
  } catch {
...
export { runWorkflowDiagnostics as runDiagnostics };
