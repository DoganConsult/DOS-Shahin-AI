...
@Component({
    ...
    selector: 'app-activityfeedcomponent',
    ...
    <div class="tab-panel">
      ...
      <app-empty-state
        *ngIf="!loading() && items().length === 0"
        title="No activity feed records"
