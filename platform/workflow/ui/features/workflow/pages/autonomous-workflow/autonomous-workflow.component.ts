...
@Component({
    ...
    selector: 'app-autonomousworkflowcomponent',
    imports: [CommonModule, EmptyStateComponent, LottieStateComponent],
    template: `
    <div class="tab-panel">
      ...
      <div *ngIf="loading()" class="loading-state">
        <app-lottie-state state="loading" message="Loading autonomous workflows..." messageAr="جارٍ تحميل سير العمل التلقائي..." [width]="160" [height]="160" />
      </div>
      <app-empty-state
        *ngIf="!loading() && items().length === 0"
        title="No autonomous workflows records"
