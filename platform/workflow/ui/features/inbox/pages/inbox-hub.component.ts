...
import { ModuleOverviewKitComponent, type ModuleOverviewKitConfig } from '@app/shared/components';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'app-inbox-hub',
  standalone: true,
  ...
  template: `
    <div class="hub-shell" [dir]="i18n.direction()">
      <header class="hub-header">
        <div class="title-row">
          <div class="icon-wrap" style="background: var(--indigo-50, #f0fdfa)">
            <i class="pi pi-inbox" style="color: var(--indigo-500)"></i>
          </div>
          <div>
            <h1>Inbox</h1>
            <p class="subtitle">Unified task inbox, approvals, and work prioritization</p>
          </div>
        </div>
      </header>
...
export class InboxHubComponent {
