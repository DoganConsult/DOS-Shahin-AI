...
// File is currently stubbed; Phase F (DB-driven UI) replaces this with
// `pnpm ui-registry:import` writing to `dos.ui_route_registry`.
import { GENERATED_MODULE_ROUTE_GROUPS, GENERATED_STANDALONE_ROUTES } from '../../config-center/routing/generated/module-route-fragments.generated';
...
export const STANDALONE_ROUTES: Record<string, StandaloneRouteEntry> = {
  ...
  // the referenced 'pages/workspace-home/workspace-home.component' path
  // never existed; the live workspace home is owned by Shahin SPA's
  // app.routes.ts and will be onboarded to DynamicPageHostComponent in
  // A7/A8 with a fresh registry entry. The 'dashboard' redirect is
  // retained — it resolves at runtime to whichever route owns
  // /workspace-home in the consuming SPA.
