...
export const MODULE_NAVIGATION_REGISTRY: Readonly<Record<string, ModuleNavContract>> = Object.freeze({
  "foundation": {
    "schemaVersion": 1,
...
export function getModuleNavContract(moduleCode: string): ModuleNavContract | undefined {
  return MODULE_NAVIGATION_REGISTRY[moduleCode];
}

export function listRegisteredModuleNav(): string[] {
