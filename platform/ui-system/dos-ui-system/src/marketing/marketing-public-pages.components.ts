...
abstract class MarketingPublicPageBase {
  ...
  @Input() breadcrumb: ReadonlyArray<DosCarbonBreadcrumbItem> | null = [];
  ...
  footerLabel(): string {
    return `© ${this.year} ${this.brandLabel || this.brandCode || ''}`.trim();
  }
  ...
  protected resolveCopy(value: MarketingCopy): string {
    if (!value) return '';
  ...
  template: `
    <main class="dos-mp-page" [attr.dir]="locale === 'ar' ? 'rtl' : 'ltr'" [attr.data-page-id]="pageId">
      ...
      <section class="dos-mp-section" data-section-id="kit-flow">
        <dos-carbon-grid [narrow]="true">
          <dos-carbon-row class="dos-mp-kit-layout">
            <dos-carbon-col [columnNumbers]="featureColumns">
              @if (featuredAsset(); as asset) {
                ...
                <dos-carbon-inline-loading state="active" [loadingText]="loadingCopy"></dos-carbon-inline-loading>
              }
            </dos-carbon-col>
            ...
            <dos-carbon-row>
              <dos-carbon-col [columnNumbers]="heroColumns">
                <dos-download-success
                  ...
                  [downloadNowLabel]="downloadNowLabel"
...
export class DosMarketingExecutiveKitPageComponent extends MarketingPublicPageBase implements OnInit {
  ...
  @Input() interestAreas: ReadonlyArray<string> = [];
  @Input() successHeading = '';
  @Input() successBody = '';
  @Input() downloadNowLabel = '';
  @Input() emailLabel = '';
  @Input() bookDemoLabel = '';
  @Input() bookDemoHref = '';
  @Input() exploreLabel = '';
