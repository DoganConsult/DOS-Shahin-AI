...
export class DosCommandCenterComponent {
  @Input() moduleCode?: string;
  @Input() kpiScope: 'module-overview' | 'page-local' | 'none' = 'module-overview';
  @Input() density: 'compact' | 'cozy' | 'comfortable' = 'comfortable';
  @Input() ariaLabel = 'Command Center';
  @Input() kpiAriaLabel = 'Module KPIs';
}
