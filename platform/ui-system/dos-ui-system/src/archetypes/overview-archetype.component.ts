...
/**
 * DosOverviewArchetypeComponent — renderer for the "overview" page archetype.
 * Wave-3 scaffold. Consumes a normalized PageSpec from UI-OS runtime; renders no DB schema.
 */
@Component({
  selector: 'dos-archetype-overview',
  standalone: true,
  imports: [CommonModule, DosArchetypeBaseComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `<dos-archetype-base archetype="overview" [pageSpec]="pageSpec"></dos-archetype-base>`,
})
export class DosOverviewArchetypeComponent {
