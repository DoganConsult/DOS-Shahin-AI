...
/**
 * DosReviewArchetypeComponent — renderer for the "review" page archetype.
 * Wave-3 scaffold. Consumes a normalized PageSpec from UI-OS runtime; renders no DB schema.
 */
@Component({
  selector: 'dos-archetype-review',
  standalone: true,
  imports: [CommonModule, DosArchetypeBaseComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `<dos-archetype-base archetype="review" [pageSpec]="pageSpec"></dos-archetype-base>`,
})
export class DosReviewArchetypeComponent {
