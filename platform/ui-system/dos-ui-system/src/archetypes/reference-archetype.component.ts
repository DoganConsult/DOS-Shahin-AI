...
/**
 * DosReferenceArchetypeComponent — renderer for the "reference" page archetype.
 * Wave-3 scaffold. Consumes a normalized PageSpec from UI-OS runtime; renders no DB schema.
 */
@Component({
  selector: 'dos-archetype-reference',
  standalone: true,
  imports: [CommonModule, DosArchetypeBaseComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `<dos-archetype-base archetype="reference" [pageSpec]="pageSpec"></dos-archetype-base>`,
})
export class DosReferenceArchetypeComponent {
