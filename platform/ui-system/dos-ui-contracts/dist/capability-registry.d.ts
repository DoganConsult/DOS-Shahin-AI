 ...
 */
export declare function registerCapabilities(entries: ReadonlyArray<UiCapabilityEntry>): void;
/**
 * Register a single capability at runtime (e.g. lazy-loaded module
 * registering a domain widget after bootstrap).
 */
export declare function registerCapability(entry: UiCapabilityEntry): void;
...
export declare function listAllCapabilities(): UiCapabilityEntry[];
/**
