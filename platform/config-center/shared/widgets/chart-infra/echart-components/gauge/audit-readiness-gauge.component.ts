/**
 * AuditReadinessGaugeComponent — Gauge showing audit readiness percentage.
 *
 * Uses `buildComplianceGaugeOptions` from pie-radar-gauge-builders.
 * Requirements: 10.7
 */
...
@Component({
    selector: 'app-audit-readiness-gauge',
    imports: [CommonModule, AppEchartComponent],
    changeDetection: ChangeDetectionStrategy.OnPush,
    template: `
    <app-echart
      [options]="chartOptions"
      [ariaLabel]="'Audit Readiness Gauge'">
    </app-echart>
  `,
    styles: [`:host { display: block; width: 100%; height: 100%; }`]
})
export class AuditReadinessGaugeComponent implements OnInit, OnChanges {
