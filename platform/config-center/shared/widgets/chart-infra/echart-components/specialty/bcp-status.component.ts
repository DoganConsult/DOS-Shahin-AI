/**
 * BcpStatusComponent — BCP status with progress gauge and timeline.
 *
...
@Component({
    selector: 'app-bcp-status',
    imports: [CommonModule, AppEchartComponent],
    changeDetection: ChangeDetectionStrategy.OnPush,
    template: `
    <app-echart
      [options]="chartOptions"
      [ariaLabel]="'BCP Status Gauge'">
    </app-echart>
  `,
    styles: [`:host { display: block; width: 100%; height: 100%; }`]
})
export class BcpStatusComponent implements OnInit, OnChanges {
