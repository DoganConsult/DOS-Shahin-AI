...
export function buildRiskWaterfallOptions(steps: WaterfallStep[]): EChartsOption {
    ...
    series: [
      ...
      },
      {
        ...
        data: steps.map((s) => {
          ...
          return { value: Math.abs(s.value), itemStyle: { color: s.value >= 0 ? '#ef4444' : '#22c55e', borderRadius: [4, 4, 0, 0] } };
        }),
      },
    ],
  } as EChartsOption;
