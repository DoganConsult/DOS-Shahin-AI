/**
 * Workspace Scope Filter Component
 * 
 * Multi-dimensional workspace scope filtering for workspace-level dashboards.
 * This is distinct from the entity/framework/period scope filter bar.
 * 
 * @deprecated
 * @removal-date Phase 6 (Frontend consumption)
 * @owner DOS
 * @replacement DAuth frontend services (core/dauth/) This component serves a different use case than the canonical scope-filter-bar.
 * Consider consolidating scope filtering patterns in a future refactor.
 */
...
@Component({
    ...
    <div class="scope-filter-bar" *ngIf="dimensionGroups.length > 0">
      ...
      <button [attr.aria-label]="i18n.translate('common.clearFilters')" class="clear-btn" *ngIf="hasSelection" (click)="clearAll()">
...
export class WorkspaceScopeFilterComponent implements OnInit, OnChanges {
