// ============================================
// Workspace Scope Filter — Unit Tests
// Feature: grc-workspace-lifecycle, Task 15.1
// Requirements: 2.4, 2.5, 9.4
// ============================================
// Run: pnpm exec tsx src/app/shared/layout/workspace-scope-filter.test.ts
// 
// NOTE: This test file has been updated to test the renamed WorkspaceScopeFilterComponent.
// The component was renamed from ScopeFilterBarComponent to avoid selector conflict.
...
const src = readFileSync(resolve(__dirname, 'workspace-scope-filter.component.ts'), 'utf-8');

console.log('\n🧪 Workspace Scope Filter Component Tests\n');
...
assert(src.includes('export class WorkspaceScopeFilterComponent'), 'Component class exported');
