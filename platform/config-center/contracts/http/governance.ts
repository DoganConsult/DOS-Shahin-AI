...
export const GOVERNANCE_STATUSES: readonly GovernanceStatus[] = ['draft', 'proposed', 'approved', 'active', 'review', 'retired', 'archived'] as const;

export type GovernanceSource = 'manual' | 'import' | 'api' | 'workflow' | 'ai_agent' | 'system';

export const GOVERNANCE_SOURCES: readonly GovernanceSource[] = ['manual', 'import', 'api', 'workflow', 'ai_agent', 'system'] as const;
