...
DoD harness for Phase 1 / Module 7 (Notifications).

Options:
  --help, -h           Show this help message

Output:
  Creates timestamped proof file at ops/proofs/module-notifications-dod-<timestamp>.json

Examples:
  # Run notifications DoD proof
  $(basename "$0)
EOF
  exit 0
}
