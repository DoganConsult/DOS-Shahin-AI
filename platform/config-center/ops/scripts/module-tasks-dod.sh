...
DoD harness for Phase 2 / Module 1 (Tasks).

Options:
  --help, -h           Show this help message

Output:
  Creates timestamped proof file at ops/proofs/module-tasks-dod-<timestamp>.json

Probes:
  workflow + tasks endpoints called by Shahin pages
