...
DoD harness for Phase 2 / Module 5 (Delegation — OOO).

Options:
  --help, -h           Show this help message

Output:
  Creates timestamped proof file at ops/proofs/module-delegation-dod-<timestamp>.json

Examples:
  # Run delegation DoD proof
  $(basename "$0)
EOF
  exit 0
}
