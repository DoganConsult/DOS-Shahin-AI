...
DoD harness for Phase 1 / Module 6 (Roles & Permissions).

Options:
  --help, -h           Show this help message

Output:
  Creates timestamped proof file at ops/proofs/module-roles-permissions-dod-<timestamp>.json

Examples:
  # Run roles-permissions DoD proof
  $(basename "$0)
EOF
  exit 0
}
