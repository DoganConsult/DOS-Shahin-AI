...
@Component({
  selector: 'app-navigation-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="navigation-diagnostics">
...
export class NavigationDiagnosticsComponent implements OnInit {
  private api = inject(NavigationApiService);
