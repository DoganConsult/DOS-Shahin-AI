...
@Component({
  ...
  template: `
    <div class="dashboard-page" [dir]="i18n.direction()">
      <h2 class="page-title">{{ i18n.translate('vendor.dashboard') }}</h2>
      ...
      @if (loading()) {
        ...
        <div class="kpi-grid">
          ...
          <div class="kpi-card"><div class="kpi-value" style="color:var(--orange-500)">{{ data()!.kpis.contractsExpiring }}</div><div class="kpi-label">Contracts Expiring</div></div>
          ...
          <div class="kpi-card"><div class="kpi-value">{{ data()!.kpis.dueDiligenceOpen }}</div><div class="kpi-label">Due Diligence Open</div></div>
        </div>
...
export class VendorDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<{ data: Record<string, unknown> }>('/api/vendor/dashboard')
