...
import { GovernanceOsApiService } from '../services/governance-os-api.service';

@Component({
  selector: 'app-governance-os-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="governance-os-diagnostics">
      <h2>Governance OS Diagnostics</h2>
      @if (loading()) {
...
export class GovernanceOsDiagnosticsComponent implements OnInit {
  private api = inject(GovernanceOsApiService);
