  ...
  template: `
    <div class="hub-shell" [dir]="i18n.direction()">
      <header class="hub-header">
        <div class="title-row">
          <div class="icon-wrap" style="background: var(--cyan-50, #f0fdfa)">
            <i class="pi pi-globe" style="color: var(--cyan-500)"></i>
          </div>
          <div>
            <h1>Portals</h1>
            <p class="subtitle">External portals, vendor views, and content management</p>
          </div>
        </div>
      </header>
...
export class PortalsHubComponent {
