...
import { ReportingApiService } from '@app/reporting/reporting-api.service';

@Component({
  selector: 'app-reporting-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="reporting-diagnostics">
...
export class ReportingDiagnosticsComponent implements OnInit {
