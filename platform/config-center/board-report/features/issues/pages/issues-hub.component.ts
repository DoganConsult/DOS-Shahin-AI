  ...
  template: `
    <div class="hub-shell" [dir]="i18n.direction()">
      <header class="hub-header">
        <div class="title-row">
          <div class="icon-wrap" style="background: var(--orange-50, #f0fdfa)">
            <i class="pi pi-exclamation-triangle" style="color: var(--orange-500)"></i>
          </div>
          <div>
            <h1>Issues</h1>
            <p class="subtitle">Issue tracking, categorization, assignment, and resolution</p>
          </div>
        </div>
      </header>
...
export class IssuesHubComponent {
