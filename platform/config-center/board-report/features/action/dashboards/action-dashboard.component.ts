...
@Component({
  ...
  template: `
    <div class="dashboard-page" [dir]="i18n.direction()">
      <h2 class="page-title">{{ i18n.translate('action.dashboard') }}</h2>
      ...
      @if (loading()) {
        ...
        <div class="kpi-grid">
          ...
          <div class="kpi-card"><div class="kpi-value">{{ data()!.kpis.avgDaysOpen }}</div><div class="kpi-label">Avg Days Open</div></div>
        ...
        <div class="grid-2">
          <div class="breakdown-section">
            <div class="breakdown-card">
              ...
              @for (item of data()!.breakdownA; track item.priority) {
...
export class ActionDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<{ data: Record<string, unknown> }>('/api/action/dashboard')
