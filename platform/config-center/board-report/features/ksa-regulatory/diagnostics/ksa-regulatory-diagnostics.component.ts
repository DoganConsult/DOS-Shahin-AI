...
@Component({
  selector: 'app-ksa-regulatory-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="ksa-regulatory-diagnostics">
      <h2>KSA Regulatory Diagnostics</h2>
      @if (loading()) {
...
export class KsaRegulatoryDiagnosticsComponent implements OnInit {
