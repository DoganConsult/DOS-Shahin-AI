// AI Governance — Model Drift page (ai-model-drift).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/model-provenance, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-model-drift',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-model-drift.component.html',
})
export class AiModelDriftComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/model-provenance').subscribe({
      next: (res) => {
