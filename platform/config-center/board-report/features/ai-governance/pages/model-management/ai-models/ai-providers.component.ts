...
@Component({
    ...
    <div class="module-page" [dir]="i18n.direction()">
      <div class="page-header">
        <h1 class="page-title">{{ i18n.translate('aiGov.aiProviders') || 'AI Providers' }}</h1>
        <p class="page-subtitle">Manage AI system providers, deployers, and distributors per EU AI Act.</p>
      </div>
      ...
      <div class="section-card">
        ...
        <table class="data-table">
          <thead><tr><th>Name</th><th>Role</th><th>Jurisdiction</th><th>Systems</th><th>Compliancescore</th><th>Status</th><th>Lastaudit</th></tr></thead>
          <tbody>
...
export class AiProvidersComponent implements OnInit {
  ...
  protected readonly items = signal<AiProvider[]>([]);
  ...
  ngOnInit(): void {
    this.http.get<AiProvider[]>('/api/ai-governance/providers').subscribe({ next: (d) => this.items.set(d), error: () => {} });
  }
