// AI Governance — Model Risk page (ai-model-risk-dashboard).
...
@Component({
  ...
  selector: 'app-ai-model-risk-dashboard',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-model-risk-dashboard.component.html',
})
export class AiModelRiskDashboardComponent implements OnInit {
