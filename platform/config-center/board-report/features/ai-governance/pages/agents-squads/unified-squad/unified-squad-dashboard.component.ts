// AI Governance — Unified Squad page (unified-squad-dashboard).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-engine/squad/unified-squad, explicit loading/error/empty/ready
...
interface Row {
  squadId?: string | number | boolean | null;
  agents?: string | number | boolean | null;
  runStatus?: string | number | boolean | null;
...
@Component({
  ...
  templateUrl: './unified-squad-dashboard.component.html',
})
export class UnifiedSquadDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-engine/squad/unified-squad').subscribe({
      next: (res) => {
