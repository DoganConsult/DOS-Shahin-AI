// AI Governance — Agent Performance page (ai-agent-performance-dashboard).
...
interface Row {
  ...
  runs24h?: string | number | boolean | null;
  successRate?: string | number | boolean | null;
  meanLatencyMs?: string | number | boolean | null;
  [key: string]: unknown;
}

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'app-ai-agent-performance-dashboard',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-agent-performance-dashboard.component.html',
})
export class AiAgentPerformanceDashboardComponent implements OnInit {
