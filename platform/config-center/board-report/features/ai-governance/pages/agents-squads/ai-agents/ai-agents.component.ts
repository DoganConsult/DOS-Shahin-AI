...
export class AiAgentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-engine/agents').subscribe({
      next: (res) => {
