// AI Governance — Alerts & Kill-Switches page (ai-alerts-killswitch).
...
@Component({
  ...
  selector: 'app-ai-alerts-killswitch',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-alerts-killswitch.component.html',
})
export class AiAlertsKillswitchComponent implements OnInit {
