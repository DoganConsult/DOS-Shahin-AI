// AI Governance — Fairness Monitor page (ai-fairness).
...
@Component({
  ...
  selector: 'app-ai-fairness',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-fairness.component.html',
})
export class AiFairnessComponent implements OnInit {
