// AI Governance — Maturity Scorecard page (ai-maturity-scorecard).
...
@Component({
  ...
  selector: 'app-ai-maturity-scorecard',
  standalone: true,
  imports: [CommonModule, CardModule],
  templateUrl: './ai-maturity-scorecard.component.html',
})
export class AiMaturityScorecardComponent implements OnInit {
