...
interface Row {
  ...
  toolCount?: string | number | boolean | null;
  [key: string]: unknown;
}
...
export class McpAdminComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-engine/openclaw/a2a').subscribe({
      next: (res) => {
