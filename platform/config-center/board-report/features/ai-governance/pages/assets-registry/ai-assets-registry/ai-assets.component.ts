// AI Governance — AI Asset Registry page (ai-assets).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/system-registry, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-assets',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-assets.component.html',
})
export class AiAssetsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/system-registry').subscribe({
      next: (res) => {
