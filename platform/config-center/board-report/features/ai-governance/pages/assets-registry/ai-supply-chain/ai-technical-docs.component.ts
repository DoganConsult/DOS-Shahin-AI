...
@Component({
    selector: 'app-ai-technical-docs',
    imports: [CommonModule, RouterModule],
    changeDetection: ChangeDetectionStrategy.OnPush,
    template: `
    <div class="module-page" [dir]="i18n.direction()">
      <div class="page-header">
        <h1 class="page-title">{{ i18n.translate('aiGov.aiTechnicalDocs') || 'Technical Documentation' }}</h1>
        <p class="page-subtitle">Manage technical documentation requirements per EU AI Act Annex IV.</p>
      </div>
      ...
      <div class="section-card">
        ...
        <table class="data-table">
          <thead><tr><th>Systemname</th><th>Doctype</th><th>Version</th><th>Completeness</th><th>Lastupdated</th><th>Reviewer</th><th>Status</th></tr></thead>
          <tbody>
...
export class AiTechnicalDocsComponent implements OnInit {
  protected readonly i18n = inject(I18nService);
  private readonly http = inject(HttpClient);
  protected readonly items = signal<TechnicalDoc[]>([]);
  ...
  ngOnInit(): void {
    this.http.get<TechnicalDoc[]>('/api/ai-governance/technical-docs').subscribe({ next: (d) => this.items.set(d), error: () => {} });
  }
