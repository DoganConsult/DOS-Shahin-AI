// AI Governance — Governance Shell page (ai-governance-shell).
...
@Component({
  ...
  selector: 'app-ai-governance-shell',
  standalone: true,
  imports: [CommonModule, CardModule],
  templateUrl: './ai-governance-shell.component.html',
})
export class AiGovernanceShellComponent implements OnInit {
