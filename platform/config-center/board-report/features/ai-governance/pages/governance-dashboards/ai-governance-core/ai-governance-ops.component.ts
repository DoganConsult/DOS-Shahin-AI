// AI Governance — Governance Operations page (ai-governance-ops).
...
@Component({
  ...
  selector: 'app-ai-governance-ops',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-governance-ops.component.html',
})
export class AiGovernanceOpsComponent implements OnInit {
