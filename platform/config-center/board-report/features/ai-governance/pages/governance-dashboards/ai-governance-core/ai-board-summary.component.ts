// AI Governance — Board-Level Summary page (ai-board-summary).
...
@Component({
  ...
  selector: 'app-ai-board-summary',
  standalone: true,
  imports: [CommonModule, CardModule],
  templateUrl: './ai-board-summary.component.html',
})
export class AiBoardSummaryComponent implements OnInit {
