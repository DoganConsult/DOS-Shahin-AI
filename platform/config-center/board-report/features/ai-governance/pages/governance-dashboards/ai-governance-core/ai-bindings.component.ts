// AI Governance — AI-Role Bindings page (ai-bindings).
...
@Component({
  ...
  selector: 'app-ai-bindings',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-bindings.component.html',
})
export class AiBindingsComponent implements OnInit {
