// AI Governance — AI Governance Roles page (ai-governance-roles).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/agent-authority, explicit loading/error/empty/ready
...
interface Row {
  ...
  tenant_id?: string | number | boolean | null;
...
@Component({
  ...
  selector: 'app-ai-governance-roles',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-governance-roles.component.html',
})
export class AiGovernanceRolesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/agent-authority').subscribe({
      next: (res) => {
