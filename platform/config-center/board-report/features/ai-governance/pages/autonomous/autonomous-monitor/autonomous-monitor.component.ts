// AI Governance — Autonomous Monitor page (autonomous-monitor).
...
interface Row {
  ...
  autonomyLevel?: string | number | boolean | null;
...
export class AutonomousMonitorComponent implements OnInit {
