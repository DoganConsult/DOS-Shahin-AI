// AI Governance — Mismatches & Incidents page (ai-mismatches).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/serious-incidents, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-mismatches',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-mismatches.component.html',
})
export class AiMismatchesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/serious-incidents').subscribe({
      next: (res) => {
