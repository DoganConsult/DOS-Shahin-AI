// AI Governance — Compliance Frameworks page (ai-compliance-framework-dashboard).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/conformity-status, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-compliance-framework-dashboard',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-compliance-framework-dashboard.component.html',
})
export class AiComplianceFrameworkDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/conformity-status').subscribe({
      next: (res) => {
