// AI Governance — Impact Assessments page (ai-impact-assessment).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/privacy-impact, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-impact-assessment',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-impact-assessment.component.html',
})
export class AiImpactAssessmentComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/privacy-impact').subscribe({
      next: (res) => {
