// AI Governance — Enforcement Actions page (ai-enforcement).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/corrective-actions, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-enforcement',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-enforcement.component.html',
})
export class AiEnforcementComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/corrective-actions').subscribe({
      next: (res) => {
