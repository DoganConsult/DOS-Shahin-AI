// AI Governance — Ethics Board Declarations page (ai-ethics-board).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/declarations, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-ethics-board',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-ethics-board.component.html',
})
export class AiEthicsBoardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/declarations').subscribe({
      next: (res) => {
