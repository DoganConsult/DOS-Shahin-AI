// AI Governance — EU AI Act Classification page (ai-eu-classification).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/risk-classification, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-eu-classification',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-eu-classification.component.html',
})
export class AiEuClassificationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/risk-classification').subscribe({
      next: (res) => {
