// AI Governance — Regulatory Changes page (ai-regulatory-changes).
// Phase 2 i18n + API hardening: I18nService bindings (RTL via dir(),
// bilingual labels), ApiClientService fetch against the canonical
// platform endpoint /ai-governance/post-market, explicit loading/error/empty/ready
...
@Component({
  ...
  selector: 'app-ai-regulatory-changes',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-regulatory-changes.component.html',
})
export class AiRegulatoryChangesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<unknown>('/ai-governance/post-market').subscribe({
      next: (res) => {
