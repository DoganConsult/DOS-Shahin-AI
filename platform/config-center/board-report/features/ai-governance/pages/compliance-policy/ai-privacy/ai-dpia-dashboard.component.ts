// AI Governance — DPIA Dashboard page (ai-dpia-dashboard).
...
@Component({
  ...
  selector: 'app-ai-dpia-dashboard',
  standalone: true,
  imports: [CommonModule, CardModule, TableModule, TagModule],
  templateUrl: './ai-dpia-dashboard.component.html',
})
export class AiDpiaDashboardComponent implements OnInit {
