...
@Component({
    selector: 'app-ai-privacy-impact',
    imports: [CommonModule, RouterModule],
    changeDetection: ChangeDetectionStrategy.OnPush,
    template: `
    <div class="module-page" [dir]="i18n.direction()">
      <div class="page-header">
        <h1 class="page-title">{{ i18n.translate('aiGov.aiPrivacyImpact') || 'Privacy Impact' }}</h1>
        <p class="page-subtitle">Conduct and manage AI-specific privacy impact assessments (AI-DPIA).</p>
      </div>
      ...
      <div class="section-card">
        ...
        <table class="data-table">
          <thead><tr><th>Systemname</th><th>Impactlevel</th><th>Datasubjects</th><th>Mitigations</th><th>Status</th><th>Assessor</th><th>Completedat</th></tr></thead>
          <tbody>
...
export class AiPrivacyImpactComponent implements OnInit {
  protected readonly i18n = inject(I18nService);
  private readonly http = inject(HttpClient);
  protected readonly items = signal<PrivacyImpact[]>([]);
  ...
  ngOnInit(): void {
    this.http.get<PrivacyImpact[]>('/api/ai-governance/privacy-impact').subscribe({ next: (d) => this.items.set(d), error: () => {} });
  }
