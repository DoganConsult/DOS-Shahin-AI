...
@Component({
  selector: 'app-proactive-leadership-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="proactive-leadership-diagnostics">
      <h2>Proactive Leadership Diagnostics</h2>
      @if (loading()) {
...
export class ProactiveLeadershipDiagnosticsComponent implements OnInit {
