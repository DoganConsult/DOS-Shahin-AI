...
@Component({
  selector: 'app-governance-ai-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="governance-ai-diagnostics">
      <h2>Governance AI Diagnostics</h2>
      @if (loading()) {
...
export class GovernanceAiDiagnosticsComponent implements OnInit {
