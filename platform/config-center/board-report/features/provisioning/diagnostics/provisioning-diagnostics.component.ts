...
@Component({
  selector: 'app-provisioning-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="provisioning-diagnostics">
      <h2>Provisioning Diagnostics</h2>
      @if (loading()) {
...
export class ProvisioningDiagnosticsComponent implements OnInit {
