...
@Component({
  selector: 'app-integrations-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="integrations-diagnostics">
      <h2>Integrations Diagnostics</h2>
      @if (loading()) {
...
export class IntegrationsDiagnosticsComponent implements OnInit {
