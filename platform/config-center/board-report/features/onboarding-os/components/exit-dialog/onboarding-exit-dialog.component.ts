...
@Component({
  ...
  `,
    ...
    .onb-exit-dialog {
      ...
      text-align: center;
      box-shadow: var(--shadow-lg, 0 8px 24px -4px rgba(0,0,0,0.14), 0 4px 8px rgba(0,0,0,0.06));
      animation: slideUp 0.2s cubic-bezier(0.4,0,0.2,1);
    }
    .onb-exit-icon { font-size: 2.5rem; color: var(--warning, var(--warning)); margin-bottom: 0.75rem; }
    .onb-exit-dialog h3 { margin: 0 0 0.5rem; font-size: 1.25rem; color: var(--text-color); }
    .onb-exit-dialog p { margin: 0 0 1.5rem; font-size: 0.9rem; color: var(--text-color-secondary); line-height: 1.6; }
