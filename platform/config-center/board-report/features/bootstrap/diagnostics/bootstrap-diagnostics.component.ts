...
import { BootstrapApiService } from '../services/bootstrap-api.service';

@Component({
  selector: 'app-bootstrap-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="bootstrap-diagnostics">
      <h2>Bootstrap Diagnostics</h2>
      @if (loading()) {
...
export class BootstrapDiagnosticsComponent implements OnInit {
  private api = inject(BootstrapApiService);
