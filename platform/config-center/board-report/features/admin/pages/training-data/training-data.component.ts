...
@Component({
    ...
    selector: 'app-trainingdatacomponent',
    ...
    <div class="tab-panel">
      ...
      <app-empty-state
        *ngIf="!loading() && items().length === 0"
        title="No training data records"
