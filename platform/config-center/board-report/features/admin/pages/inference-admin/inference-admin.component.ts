...
@Component({
    ...
    selector: 'app-inferenceadmincomponent',
    imports: [CommonModule, EmptyStateComponent],
    template: `
    <div class="tab-panel">
      <div class="tab-header">
        <i class="pi pi-microchip"></i>
        <h2>Inference Admin</h2>
      </div>
      ...
      <app-empty-state
        *ngIf="!loading() && items().length === 0"
        title="No inference admin records"
