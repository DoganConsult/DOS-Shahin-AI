...
import { QualityGateDashboardComponent } from '../quality-gate-dashboard/quality-gate-dashboard.component';
...
const TABS: HubTab[] = [
  ...
  { key: 'quality-gate', labelKey: 'adminHub.tabQualityGate',  icon: 'pi-verified' },
];
...
@Component({
    ...
    imports: [CommonModule, RouterModule, AdministrationComponent, QualityGateDashboardComponent, AgentBadgeComponent, HubConnectionsStripComponent, HubHelpPanelComponent],
    styles: [`
    :host{display:block}
  ...
  `],
    ...
    <div class="grc-hub" [dir]="i18n.direction()">
      ...
      <div class="hub-tab-content">
        ...
        @if (activeTab()==='quality-gate') { <app-quality-gate-dashboard /> }
      </div>
    </div>`
})
export class AdminHubComponent implements OnInit {
  ...
  summaryCards = computed<SummaryCard[]>(() => {
    ...
    return [
      { key: 'users',           icon: 'pi-users',     color: '#4f46e5', value: '' + users, labelKey: 'adminHub.cardUsers',          route: '/admin/users' },
      { key: 'tenants',         icon: 'pi-building',  color: '#0ea5e9', value: '—',        labelKey: 'adminHub.cardTenants',         route: '/admin/tenants' },
      { key: 'tenant-settings', icon: 'pi-cog',       color: '#7c3aed', value: '—',        labelKey: 'adminHub.cardTenantSettings',  route: '/admin/tenant-settings' },
      { key: 'user-settings',   icon: 'pi-user-edit', color: '#0891b2', value: '—',        labelKey: 'adminHub.cardUserSettings',    route: '/admin/user-settings' },
