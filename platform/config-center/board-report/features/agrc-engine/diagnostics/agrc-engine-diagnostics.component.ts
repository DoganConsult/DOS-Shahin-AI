...
@Component({
  selector: 'app-agrc-engine-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="agrc-engine-diagnostics">
      <h2>AGRC Engine Diagnostics</h2>
      @if (loading()) {
...
export class AgrcEngineDiagnosticsComponent implements OnInit {
