...
interface AgentRow {
  agentCode: string; name: string; domain: string;
}
...
@Component({
  ...
  templateUrl: './agent-sandbox.component.html',
})
export class AgentSandboxComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api.get<{ data?: AgentRow[] }>('/ai-engine/agents').subscribe({
      next: (res) => {
