// AI Cockpit — Agent Comparison page.
...
interface AgentRow {
  agentCode: string; name: string; domain: string; runs24h: number; successRate: number; meanLatencyMs: number; eligibleForProduction: boolean;
}
