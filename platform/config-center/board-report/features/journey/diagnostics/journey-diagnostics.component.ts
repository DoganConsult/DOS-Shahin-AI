...
@Component({
  selector: 'app-journey-diagnostics',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <div class="journey-diagnostics">
...
export class JourneyDiagnosticsComponent implements OnInit {
  private api = inject(JourneyApiService);
