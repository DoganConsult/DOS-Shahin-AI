...
import { MessagingComponent } from '../../../dnoc/modules/messaging/messaging.component';
...
@Component({
  ...
  selector: 'app-operations-hub', standalone: true,
  imports: [CommonModule, RouterModule, TimelineComponent, MessagingComponent, ActionItemsComponent, ActivityFeedComponent, AgentBadgeComponent, HubConnectionsStripComponent, HubHelpPanelComponent],
  styles: [HUB_STYLES],
  template: `
