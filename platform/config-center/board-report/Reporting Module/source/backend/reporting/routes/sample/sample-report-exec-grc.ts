// ═══════════════════════════════════
// Executive GRC Dashboard — DB-driven
// ═══════════════════════════════════

import { shell, bi, esc, fetchTenantName, fetchFrameworks, fetchRisks, fetchControls, fetchEvidenceTasks } from './sample-report-shared';
...
export function getDemoGrcFws(): FwRow[] {
  return [
    { n: "NCA ECC", s: 78, t: "↑ +5%" },
    { n: "SAMA CSF", s: 82, t: "↑ +3%" },
    { n: "PDPL", s: 55, t: "→ 0%" },
...
export function getDemoGrcRiskCats(): RiskCatRow[] {
  return [
