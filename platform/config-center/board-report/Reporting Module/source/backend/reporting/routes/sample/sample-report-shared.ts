// ============================================
// Shahin-Ai — Shared types, data fetchers, and HTML helpers
// for bilingual sample report generators.
// ============================================

import { safeQuery, tenantSchema } from '../../ports/database.port';

/** Generic DB row shape returned by pg query results. */
...
export async function fetchEvidenceTasks(tenantId: string): Promise<TenantEvidenceTask[]> {
  ...
  return result.rows.map((r: GenericRow) => ({
    ...
    collectedAt: r.assigned_at as string,
  }));
}
...
// ═══════════════════════════════════════════
// Bilingual shell with Chart.js + AR/EN toggle
// ═══════════════════════════════════════════
