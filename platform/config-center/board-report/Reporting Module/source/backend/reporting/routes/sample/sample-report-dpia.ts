// ═══════════════════════════════════
// PDPL DPIA — DB-driven (policy & risk data)
// ═══════════════════════════════════

import { shell, bi, esc, fetchTenantName, fetchRisks, fetchPolicies } from './sample-report-shared';
...
/** Demo DPIA risk data. */
export function getDemoDpiaRisks(): RiskRow[] {
  return [
...
export function getDemoDpiaPolicies(): PolicyRow[] {
  return [
