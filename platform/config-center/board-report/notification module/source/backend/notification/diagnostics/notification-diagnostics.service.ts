/**
 * NotificationDiagnosticsService — production health checks (Rule 6.1)
 */
...
export async function runNotificationDiagnostics(tenantId: string): Promise<DiagnosticsReport> {
  ...
  try {
    ...
    checks.push({
      ...
      details: `Found ${cnt} notification tables`,
    });
  } catch {
...
export { runNotificationDiagnostics as runDiagnostics };
