/**
 * Phase 3 — packs subscriber for foundation.scope_changed.
 */
...
import { getSubscriptionHandlers } from './packs.subscribers';

const { createProcessTaskMock } = mocks;

describe('Phase 3 packs ← foundation.scope_changed', () => {
