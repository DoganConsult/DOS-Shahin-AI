...
import { AnalyticsDashboardComponent } from '../../modules/analytics-dashboard/analytics-dashboard.component';
import { SharedDashboardComponent } from '../../../config-center/board-report/features/analytics/pages/shared-dashboard/shared-dashboard.component';
import { DashboardSharingComponent } from '../../../config-center/board-report/features/analytics/pages/dashboard-sharing/dashboard-sharing.component';
import { DataExplorerComponent } from '../../../config-center/board-report/features/analytics/pages/data-explorer/data-explorer.component';
...
@Component({
  ...
  imports: [CommonModule, RouterModule, AnalyticsDashboardComponent, SharedDashboardComponent, DashboardSharingComponent, DataExplorerComponent, AgentBadgeComponent, HubConnectionsStripComponent],
  styles: [HUB_STYLES],
  template: `
